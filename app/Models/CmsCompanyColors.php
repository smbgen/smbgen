...
CSS;
        ...
        // Light-first safety net: override common dark-only Tailwind patterns that AI may generate.
        // These reset dark-only text/bg colors to readable defaults for light-mode CMS pages.
        $css .= <<<'CSS'

/* ─── Light-first safety net ────────────────────────────────────────────────
   CMS pages are light-background by default.
   These overrides ensure AI-generated content using dark-only Tailwind classes
   is still readable in light mode without a .dark parent class.
   ─────────────────────────────────────────────────────────────────────────── */
.text-gray-100 { color: #111827 !important; }
.text-gray-200 { color: #1f2937 !important; }
.text-white    { color: #111827 !important; }

/* Dark-only info/tip box patterns */
.bg-yellow-900\/20, .bg-yellow-900\/30 {
  background-color: #fefce8 !important;
}
.bg-blue-900\/20, .bg-blue-900\/30 {
  background-color: #eff6ff !important;
}
.bg-green-900\/20, .bg-green-900\/30 {
  background-color: #f0fdf4 !important;
}
.bg-red-900\/20, .bg-red-900\/30 {
...
.border-yellow-600 { border-color: #fde047 !important; }
.border-blue-600   { border-color: #93c5fd !important; }
.border-red-600    { border-color: #fca5a5 !important; }
CSS;
