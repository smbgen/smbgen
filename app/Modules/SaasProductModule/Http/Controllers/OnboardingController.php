...
use App\Modules\SaasProductModule\Jobs\DispatchInitialScanJob;
...
class OnboardingController extends Controller
{
    public function profile(Request $request): View
    {
        ...
        return view('saasproductmodule::onboarding.profile', compact('profile'));
    }
    ...
    public function storeProfile(Request $request): RedirectResponse
    {
        ...
        return redirect()->route('saasproductmodule.onboarding.contact');
    }
    ...
    public function contact(Request $request): View
    {
        ...
        return view('saasproductmodule::onboarding.contact', compact('profile'));
    }
    ...
    public function storeContact(Request $request): RedirectResponse
    {
        ...
        return redirect()->route('saasproductmodule.onboarding.addresses');
    }
    ...
    public function addresses(Request $request): View
    {
        ...
        return view('saasproductmodule::onboarding.addresses', compact('profile'));
    }
    ...
    public function storeAddresses(Request $request): RedirectResponse
    {
        ...
        return redirect()->route('saasproductmodule.onboarding.confirm');
    }
    ...
    public function confirm(Request $request): View
    {
        ...
        return view('saasproductmodule::onboarding.confirm', compact('profile'));
    }
