...
namespace App\Modules\SaasProductModule\Services;
...
class SubscriptionService
{
    ...
    {
        $subscription = $user->subscription('saasproductmodule');
    ...
    public function getCheckoutUrl(User $user, SubscriptionTier $tier, string $successUrl, string $cancelUrl): string
    {
        ...
        return $user->newSubscription('saasproductmodule', $tier->stripePriceId())
            ->checkout([
    ...
    {
        $user->subscription('saasproductmodule')?->cancel();
    }
}
