...
<div class="max-w-lg mx-auto px-6 py-16">
    ...
    <div class="bg-white/5 border border-white/10 rounded-2xl p-6">
        <form action="{{ route('saasproductmodule.onboarding.addresses') }}" method="POST" class="space-y-5">
            @csrf
            ...
            <div class="pt-2 flex items-center gap-4">
                <a href="{{ route('saasproductmodule.onboarding.contact') }}" class="text-sm text-gray-500 hover:text-gray-300 transition-colors flex items-center gap-1.5">
