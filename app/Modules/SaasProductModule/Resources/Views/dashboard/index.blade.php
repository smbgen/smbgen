...
<div class="max-w-5xl mx-auto px-6 py-12">
    ...
    <div class="flex items-start justify-between mb-10">
        ...
        <a href="{{ route('saasproductmodule.billing.plans') }}" class="inline-flex items-center gap-2 px-4 py-2 rounded-lg border border-white/10 hover:border-white/20 bg-white/5 text-gray-300 hover:text-white text-xs font-medium transition-all">
