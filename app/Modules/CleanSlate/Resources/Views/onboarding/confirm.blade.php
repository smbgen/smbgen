...
<div class="max-w-lg mx-auto px-6 py-16">
    ...
    <div class="flex items-center gap-5">
        <a href="{{ route('cleanslate.onboarding.addresses') }}" class="text-sm text-gray-500 hover:text-gray-300 transition-colors flex items-center gap-1.5">
        ...
        <form action="{{ route('cleanslate.onboarding.launch') }}" method="POST">
            @csrf
