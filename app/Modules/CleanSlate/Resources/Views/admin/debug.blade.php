...
<div class="mb-8">
    ...
    <div class="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-4 gap-3">
        @foreach([
            ...
            ['label' => 'Onboarding Step 3',   'route' => 'cleanslate.onboarding.addresses','icon' => 'fa-map-marker-alt', 'color' => 'text-violet-400'],
            ['label' => 'Onboarding Step 4',   'route' => 'cleanslate.onboarding.confirm',  'icon' => 'fa-check-circle',   'color' => 'text-violet-400'],
            ['label' => 'Customer Dashboard',  'route' => 'cleanslate.dashboard',           'icon' => 'fa-shield-halved',  'color' => 'text-violet-400'],
            ['label' => 'Admin: Customers',    'route' => 'admin.cleanslate.index',         'icon' => 'fa-users',          'color' => 'text-primary-400'],
            ['label' => 'Admin: Brokers',      'route' => 'admin.cleanslate.brokers',       'icon' => 'fa-database',       'color' => 'text-primary-400'],
            ['label' => 'Admin: Debug',        'route' => 'admin.cleanslate.debug',         'icon' => 'fa-bug',            'color' => 'text-primary-400'],
        ] as $link)
