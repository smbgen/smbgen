...
LIGHT-FIRST THEMING (CRITICAL):
- ALL text must be readable on a white/light background by default
- Never use dark-only Tailwind text colors like text-gray-100, text-white, text-yellow-200, text-blue-200 as the base class
- Never use dark-only backgrounds like bg-gray-800, bg-gray-900, bg-gray-950 without a light fallback
- For colored info boxes: always use light backgrounds (bg-yellow-50, bg-blue-50) with dark text (text-yellow-800, text-blue-800) — NOT bg-yellow-900/20 with text-yellow-200
- Correct pattern: bg-yellow-50 border border-yellow-200 text-yellow-800
- Wrong pattern: bg-yellow-900/20 border-yellow-600 text-yellow-200 (dark-only, invisible in light mode)
...
- Never use dark-only Tailwind text colors like text-gray-100, text-white, text-yellow-200, text-blue-200 as the base class
- Never use dark-only backgrounds like bg-gray-800, bg-gray-900, bg-gray-950 without a light fallback
- For colored info boxes: always use light backgrounds (bg-yellow-50, bg-blue-50) with dark text (text-yellow-800, text-blue-800)
- Correct pattern: bg-yellow-50 border border-yellow-200 text-yellow-800
- Wrong pattern: bg-yellow-900/20 border-yellow-600 text-yellow-200 (dark-only, invisible in light mode)
