...
<div x-data="aiContentGenerator()" 
    ...
    <div class="flex min-h-screen items-center justify-center p-4 sm:p-6 lg:p-8">
        <div class="relative w-full max-w-4xl bg-gray-800 rounded-lg shadow-2xl"
             x-show="isOpen"
             x-transition:enter="ease-out duration-300"
            ...
            <div class="flex items-center justify-between border-b border-gray-700 px-6 py-4">
                <div class="flex items-center gap-3">
                    ...
                    <div>
                        <h3 class="text-xl font-semibold text-white">AI Content Generator</h3>
            ...
            <div class="p-6 space-y-6">
                ...
                <div x-data="{ showAdvanced: false }" class="border-t border-gray-700 pt-4">
                    <button type="button" 
                ...
                <div x-show="generatedContent" x-cloak class="border border-gray-700 bg-gray-900 rounded-lg p-4 shadow-sm">
                    <div class="flex items-center justify-between mb-3">
                        <h4 class="font-semibold text-white">Generated Content</h4>
                        <button type="button" 
                    ...
                    <div class="max-w-none max-h-96 overflow-y-auto">
                        <pre class="text-sm text-gray-100 whitespace-pre-wrap font-mono" x-html="generatedContent"></pre>
                    </div>
                </div>
            ...
            <!-- Footer -->
            <div class="flex items-center justify-between border-t border-gray-700 px-6 py-4 bg-gray-750">
