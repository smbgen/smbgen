...
<div class="bg-white dark:bg-gray-800/50 backdrop-blur-sm rounded-2xl p-6 border border-gray-200 dark:border-gray-700 shadow-xl">
    ...
    @if($leads->count() > 0)
    <div class="mt-6">
        <a href="{{ route('admin.leads.index') }}" class="block text-center bg-gray-200 dark:bg-gray-700 hover:bg-gray-300 dark:hover:bg-gray-600 text-gray-900 dark:text-white rounded-xl py-3 transition-colors font-medium">
