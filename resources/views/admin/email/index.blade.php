    ...
    <div class="max-w-6xl mx-auto">
        ...
        <div class="mb-6 flex items-center justify-between">
            <div>
                ...
                <p class="text-gray-400">Send emails to clients, users, or custom recipients</p>
            </div>
        ...
        <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
                ...
                <div class="bg-gray-800 rounded-lg shadow-lg p-6">
                    <form action="{{ route('admin.email.send') }}" method="POST" id="emailForm">
                        ...
                        <div class="mb-6 relative">
                            ...
                            <!-- Loading Indicator -->
                            <div id="autocompleteLoading" class="hidden absolute z-10 w-full mt-1 bg-gray-700 border border-gray-600 rounded-lg shadow-lg p-3">
                            ...
                            <p class="mt-1 text-xs text-gray-400">Start typing to see clients, users, and booking emails. Separate multiple emails with commas/semicolons</p>
                            @error('recipients')
                        ...
                        <div class="mb-6 grid grid-cols-2 gap-4">
                            <div>
                                <label class="block text-sm font-medium text-gray-300 mb-2">Quick Add User</label>
                                <select id="quickAddUser" class="w-full bg-gray-700 border border-gray-600 text-white rounded-lg px-3 py-2 focus:ring-blue-500 focus:border-blue-500">
                            ...
                            <div>
                                <label class="block text-sm font-medium text-gray-300 mb-2">Quick Add Client</label>
                                <select id="quickAddClient" class="w-full bg-gray-700 border border-gray-600 text-white rounded-lg px-3 py-2 focus:ring-blue-500 focus:border-blue-500">
                        ...
                        <div class="flex gap-3">
                            ...
                            <button type="button" onclick="document.getElementById('emailForm').reset()" 
                                    class="bg-gray-700 hover:bg-gray-600 text-white font-medium px-6 py-3 rounded-lg transition-colors">
                                Clear
                            </button>
                        </div>
                    </form>
            ...
            <div class="space-y-6">
                ...
                <div class="bg-gray-800 rounded-lg shadow-lg p-6">
                    ...
                    <div class="space-y-2">
                        <button onclick="loadTemplate('welcome')" class="w-full text-left px-3 py-2 bg-gray-700 hover:bg-gray-600 text-gray-300 rounded transition-colors text-sm">
                            Welcome Email
                        </button>
                        <button onclick="loadTemplate('login_assistance')" class="w-full text-left px-3 py-2 bg-gray-700 hover:bg-gray-600 text-gray-300 rounded transition-colors text-sm">
                            <i class="fas fa-sign-in-alt mr-2 text-blue-400"></i>Login Help
                        </button>
                        <button onclick="loadTemplate('password_reset')" class="w-full text-left px-3 py-2 bg-gray-700 hover:bg-gray-600 text-gray-300 rounded transition-colors text-sm">
                            <i class="fas fa-key mr-2 text-yellow-400"></i>Password Reset
                        </button>
                        <button onclick="loadTemplate('booking_reminder')" class="w-full text-left px-3 py-2 bg-gray-700 hover:bg-gray-600 text-gray-300 rounded transition-colors text-sm">
                            Appointment Reminder
                        </button>
                        <button onclick="loadTemplate('follow_up')" class="w-full text-left px-3 py-2 bg-gray-700 hover:bg-gray-600 text-gray-300 rounded transition-colors text-sm">
                            Follow-up Email
                        </button>
                        <button onclick="loadTemplate('thank_you')" class="w-full text-left px-3 py-2 bg-gray-700 hover:bg-gray-600 text-gray-300 rounded transition-colors text-sm">
                            Thank You Email
                        </button>
                    </div>
                </div>
                ...
                <!-- Email Info -->
                <div class="bg-gray-800 rounded-lg shadow-lg p-6">
                    <h3 class="text-lg font-semibold text-white mb-4">ℹ️ Email Info</h3>
                    <div class="space-y-3 text-sm">
                        <div>
                            <span class="text-gray-400">From:</span>
                            <div class="text-white font-mono text-xs mt-1">{{ config('mail.from.address', 'Not configured') }}</div>
                        </div>
                        <div>
                            <span class="text-gray-400">Mailer:</span>
                            <div class="text-white font-mono text-xs mt-1">{{ config('mail.default', 'Not configured') }}</div>
                        </div>
                        <div>
                            <span class="text-gray-400">Host:</span>
                            <div class="text-white font-mono text-xs mt-1">{{ config('mail.mailers.smtp.host', 'Not configured') }}</div>
                        </div>
                    </div>
                </div>
                ...
                @if(config('app.debug'))
                <!-- Debug Panel -->
                <div class="bg-gray-800 rounded-lg shadow-lg p-6 border-2 border-yellow-600">
                    <h3 class="text-lg font-semibold text-yellow-400 mb-4">🐛 Debug Panel</h3>
                    <div class="space-y-3 text-xs font-mono">
                        <div>
                            <div class="text-gray-400 mb-1">API Endpoint:</div>
                            <div class="text-white bg-gray-900 p-2 rounded break-all">{{ route('admin.email.booking-emails') }}</div>
                        </div>
                        <div>
                            <div class="text-gray-400 mb-1">Last Query:</div>
                            <div id="debugLastQuery" class="text-white bg-gray-900 p-2 rounded">-</div>
                        </div>
                        <div>
