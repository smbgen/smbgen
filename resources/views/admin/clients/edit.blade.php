...
<div class="max-w-4xl mx-auto py-6">
    <div class="flex justify-between items-center mb-6">
        <h2 class="text-2xl font-bold text-gray-100">Edit Client</h2>
    ...
    <div class="card">
        <div class="bg-gray-800 px-6 py-4 rounded-t-lg">
            <h3 class="text-lg font-semibold text-gray-100 mb-0">Update Client Information</h3>
        </div>
        <div class="p-6">
            <form action="{{ route('clients.update', $client) }}" method="POST" class="space-y-6">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div>
                        ...
                        <input 
                            ...
                            class="w-full px-4 py-3 bg-gray-700 border border-gray-600 text-white rounded-lg focus:border-blue-500 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-opacity-50" 
                            required
                ...
                <div>
                    ...
                    <p class="text-sm text-gray-400 mt-1">Optional property address for real estate services</p>
