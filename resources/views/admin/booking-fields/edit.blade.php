    ...
    <div class="max-w-5xl mx-auto">
        <div class="bg-gray-800 rounded-lg shadow-xl overflow-hidden border border-gray-700">
            <div class="p-6 text-gray-100">
                ...
                <!-- Info Panel -->
                <div class="mb-6 bg-gray-700/50 border border-gray-600 rounded-lg p-4">
                    <h3 class="text-sm font-semibold text-gray-200 mb-2 flex items-center gap-2">
                        <i class="fas fa-info-circle text-gray-400"></i>
                        About Booking Form Fields
                    </h3>
                    <div class="text-sm text-gray-300 space-y-1">
                        <p><strong class="text-gray-200">Required Fields:</strong> Name and Email are always required and cannot be toggled off.</p>
                        <p><strong class="text-gray-200">Toggleable Fields:</strong> Phone, Property Address, and Notes can be shown/hidden and made optional or required.</p>
                        <p><strong class="text-gray-200">Custom Fields:</strong> Add your own custom fields to collect additional information (e.g., Budget, Property Type, Referral Source).</p>
                    </div>
                </div>
                    ...
                    <form action="{{ route('admin.booking-fields.update') }}" method="POST" x-data="formBuilder()">
                        ...
                        <div class="mb-8">
                            <h3 class="text-lg font-semibold text-gray-100 mb-4 pb-2 border-b border-gray-700">
                                ...
                                <div class="bg-gray-700/30 rounded-lg p-4 border border-gray-600">
                                    <div class="flex items-center justify-between">
                                        <div>
                                            ...
                                            <p class="text-sm text-gray-400">Customer's full name</p>
                                        </div>
                                        <span class="px-3 py-1 bg-gray-600/50 text-gray-300 text-xs font-semibold rounded-full border border-gray-500">
                                            Required
                                        </span>
                                    </div>
                                </div>
                                <div class="bg-gray-700/30 rounded-lg p-4 border border-gray-600">
                                    <div class="flex items-center justify-between">
                                        <div>
                                            ...
                                            <p class="text-sm text-gray-400">Customer's email address</p>
                                        </div>
                                        <span class="px-3 py-1 bg-gray-600/50 text-gray-300 text-xs font-semibold rounded-full border border-gray-500">
                                            Required
                                        </span>
                            ...
                            <div class="space-y-4">
                                ...
                                <div class="bg-gray-700/30 rounded-lg p-4 border border-gray-600">
                                    <div class="flex items-start justify-between mb-3">
                                        <div class="flex-1">
                                            <h4 class="font-medium text-gray-100">Phone Number</h4>
                                            <p class="text-sm text-gray-400">Customer's phone number</p>
                                        </div>
                                        <div class="flex items-center ml-4">
                                            ...
                                            <input type="checkbox" name="show_phone" id="show_phone" value="1" 
                                                   ...
                                                   class="form-checkbox">
                                            <label for="show_phone" class="ml-2 text-sm font-medium text-gray-200">
                                                Show Field
                                            </label>
                                        </div>
                                    </div>
                                    <div class="ml-4 pl-4 border-l-2 border-gray-600">
                                        ...
                                        <label class="flex items-center">
                                            <input type="checkbox" name="require_phone" id="require_phone" value="1" 
                                                   ...
                                                   class="form-checkbox">
                                            <span class="ml-2 text-sm text-gray-300">Make Required</span>
                                        </label>
                                    </div>
                                </div>
                                ...
                                <div class="bg-gray-700/30 rounded-lg p-4 border border-gray-600">
                                    <div class="flex items-start justify-between mb-3">
                                        <div class="flex-1">
                                            <h4 class="font-medium text-gray-100">Property Address</h4>
                                            <p class="text-sm text-gray-400">Address of property for inspection/service</p>
                                        </div>
                                        <div class="flex items-center ml-4">
                                            ...
                                            <input type="checkbox" name="show_property_address" id="show_property_address" value="1" 
                                                   ...
                                                   class="form-checkbox">
                                            <label for="show_property_address" class="ml-2 text-sm font-medium text-gray-200">
                                                Show Field
                                            </label>
                                        </div>
                                    </div>
                                ...
                                <div class="bg-gray-700/30 rounded-lg p-4 border border-gray-600">
                                    <div class="flex items-start justify-between mb-3">
                                        <div class="flex-1">
                                            <h4 class="font-medium text-gray-100">Notes / Comments</h4>
                                            <p class="text-sm text-gray-400">Additional details or special requests</p>
                                        </div>
                                        <div class="flex items-center ml-4">
                                            ...
                                            <input type="checkbox" name="show_notes" id="show_notes" value="1" 
                                                   ...
                                                   class="form-checkbox">
                                            <label for="show_notes" class="ml-2 text-sm font-medium text-gray-200">
                                                Show Field
                                            </label>
                                        </div>
                                    </div>
                        ...
                        <div class="mb-8">
                            <div class="flex justify-between items-center mb-4 pb-2 border-b border-gray-700">
                                <div>
                                    <h3 class="text-lg font-semibold text-gray-100">Custom Fields</h3>
                                    <p class="text-sm text-gray-400">Add additional fields to collect specific information</p>
                                </div>
                                    ...
                                    <div class="bg-gray-700/30 border border-gray-600 rounded-lg p-4">
                                        <div class="grid grid-cols-12 gap-3">
                                            ...
                                            <div class="col-span-3">
                                                ...
                                                <select x-model="field.type" class="w-full px-2 py-1.5 text-sm border border-gray-600 rounded bg-gray-800 text-gray-100 focus:border-gray-500 focus:ring-2 focus:ring-gray-500/20">
                                            ...
                                            <div class="col-span-3">
                                                ...
                                                <input type="text" x-model="field.name" placeholder="field_name" 
                                                       class="w-full px-2 py-1.5 text-sm border border-gray-600 rounded bg-gray-800 text-gray-100 placeholder-gray-500 focus:border-gray-500 focus:ring-2 focus:ring-gray-500/20">
                                            </div>
                                            ...
                                            <div class="col-span-1 flex items-end">
                                                <label class="flex items-center">
                                                    ...
                                                    <span class="ml-1 text-xs text-gray-400">Req</span>
                                                </label>
                                            </div>
                                            ...
                                            <div class="col-span-6">
                                                <label class="block text-xs font-medium text-gray-300 mb-1">Placeholder</label>
                                            ...
                                            <div class="col-span-6" x-show="field.type === 'select'">
                                                <label class="block text-xs font-medium text-gray-300 mb-1">Options (comma-separated)</label>
                        ...
                        <div class="mb-8">
                            ...
                            <div class="space-y-4">
                                <div class="bg-gray-700/30 rounded-lg p-4 border border-gray-600">
                                    <div class="flex items-start justify-between mb-3">
                                        <div class="flex-1">
                                            <h4 class="font-medium text-gray-100">Send Admin Notifications</h4>
                                            <p class="text-sm text-gray-400">Receive email notifications when new bookings or contact form submissions are received</p>
                                        </div>
                                        <div class="flex items-center ml-4">
                                            ...
                                            <input type="checkbox" name="send_admin_notifications" id="send_admin_notifications" value="1" 
                                                   ...
                                                   class="form-checkbox">
                                            <label for="send_admin_notifications" class="ml-2 text-sm font-medium text-gray-200">
                                                Enable
                                            </label>
                                        </div>
                                    </div>
                                    <div class="ml-4 pl-4 border-l-2 border-gray-600">
                                        <label for="admin_notification_email" class="block text-sm font-medium text-gray-300 mb-2">
                                        ...
                                        <input type="email" 
                                               ...
                                               class="w-full px-3 py-2 border border-gray-600 rounded bg-gray-800 text-gray-100 placeholder-gray-500 focus:border-gray-500 focus:ring-2 focus:ring-gray-500/20">
                                        <p class="text-xs text-gray-400 mt-1">Leave empty to notify all admin users who have opted in</p>
                                    </div>
                                </div>
                            </div>
                        </div>
