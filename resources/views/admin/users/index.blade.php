                    ...
                    <tbody>
                        @foreach($users as $user)
                            <tr>
                                ...
                                <!-- Email Column -->
                                <td class="px-6 py-4">
                                    <div class="text-gray-100">{{ $user->email }}</div>
                                ...
                                <td class="px-6 py-4">
                                    ...
                                    @else
                                        <span class="inline-flex items-center px-3 py-1.5 text-xs font-semibold rounded-full bg-gray-600 text-gray-200">
                                ...
                                <!-- Created Column -->
                                <td class="px-6 py-4">
                                    <div class="text-sm text-gray-100">{{ $user->created_at->format('M j, Y') }}</div>
    ...
    @else
        <div class="bg-gray-800 rounded-xl shadow-xl p-12 text-center">
            <div class="max-w-md mx-auto">
                ...
                <h3 class="text-2xl font-bold text-gray-100 mb-2">No Users Found</h3>
                <p class="text-gray-400 mb-6">Get started by creating your first user account.</p>
