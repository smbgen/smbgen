...
<div class="max-w-3xl mx-auto py-6">
    ...
    <div class="bg-gray-800 rounded-lg shadow-xl p-6">
        <h2 class="text-2xl font-bold text-gray-100 mb-6">Create New User</h2>
        ...
        <form action="{{ route('admin.users.store') }}" method="POST">
            ...
            <div class="mb-6">
                ...
                <input 
                    ...
                    id="name" 
                    value="{{ old('name') }}"
                    class="w-full px-4 py-2 bg-gray-700 border border-gray-600 rounded-lg focus:outline-none focus:ring-2 focus:ring-purple-500 text-gray-100"
                    required
                >
            </div>
