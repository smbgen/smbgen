        ...
        <div class="grid grid-cols-1 md:grid-cols-4 gap-4">
            <div class="admin-card">
                <div class="admin-card-body">
                    ...
                    <div class="text-2xl font-bold text-gray-200">{{ number_format($stats['total']) }}</div>
                </div>
            </div>
            <div class="admin-card">
                <div class="admin-card-body">
                    <div class="text-gray-400 text-sm">Today</div>
                    <div class="text-2xl font-bold text-gray-200">{{ number_format($stats['today']) }}</div>
                </div>
            </div>
            <div class="admin-card">
                <div class="admin-card-body">
                    <div class="text-gray-400 text-sm">This Week</div>
                    <div class="text-2xl font-bold text-gray-200">{{ number_format($stats['this_week']) }}</div>
                </div>
            </div>
            <div class="admin-card">
                <div class="admin-card-body">
                    <div class="text-gray-400 text-sm">This Month</div>
                    <div class="text-2xl font-bold text-gray-200">{{ number_format($stats['this_month']) }}</div>
                </div>
            </div>
        </div>
                    ...
                    <tbody>
                        @forelse($logs as $log)
                            <tr>
                                ...
                                <td>
                                    <div class="text-sm text-gray-200">{{ $log->description }}</div>
                                </td>
                                ...
                                <td class="whitespace-nowrap text-right text-sm font-medium">
                                    <a href="{{ route('admin.activity-logs.show', $log) }}" class="text-blue-400 hover:text-blue-300">
