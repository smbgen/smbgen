...
<div class="p-6">
    <div class="bg-white dark:bg-gray-800 p-6 rounded-xl border border-gray-200 dark:border-gray-700">
        <h1 class="text-2xl font-bold text-gray-900 dark:text-white">{{ $report->summary_title }}</h1>
        <p class="text-gray-700 dark:text-gray-300 mt-2">Client: {{ $report->client_name }} | {{ $report->client_email }}</p>
        ...
        <div class="mt-6 flex flex-wrap gap-3">
            ...
            <a href="{{ route('reports.show', $report->id) }}" class="bg-gray-200 dark:bg-gray-700 px-4 py-2 rounded text-gray-900 dark:text-white hover:bg-gray-300 dark:hover:bg-gray-600 transition inline-block">
