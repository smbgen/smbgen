...
<div x-data="{}" class="py-6">
    <div class="admin-page-header">
        <div>
            ...
            <p class="admin-page-subtitle">Write a new blog post</p>
        </div>
        ...
        <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
            ...
            <div class="lg:col-span-2 space-y-6">
                ...
                <div class="bg-white dark:bg-gray-800 rounded-lg shadow p-6">
                    ...
                    <p class="text-sm text-gray-600 dark:text-gray-400 mt-1">Leave blank to auto-generate from title</p>
                </div>

                <!-- Excerpt -->
                <div class="bg-white dark:bg-gray-800 rounded-lg shadow p-6">
                    <label class="form-label">Excerpt</label>
                    <textarea name="excerpt" rows="3" class="form-input" placeholder="Brief summary...">{{ old('excerpt') }}</textarea>
                </div>
            ...
            <div class="space-y-6">
                ...
                <div class="bg-white dark:bg-gray-800 rounded-lg shadow p-6">
                    ...
                    <div class="mb-4">
                        <input type="text" name="featured_image" id="featured_image" value="{{ old('featured_image') }}" 
                               class="form-input" placeholder="Image URL">
                    </div>
                    ...
                    <div id="featured-image-preview" class="mt-4 hidden">
                        <img src="" alt="Preview" class="w-full rounded">
                    </div>
                </div>
                ...
                <div class="bg-white dark:bg-gray-800 rounded-lg shadow p-6">
                    ...
                    <div class="mb-4">
                        ...
                        <input type="text" name="seo_title" id="seo_title" value="{{ old('seo_title') }}" class="form-input" maxlength="60">
                        <p class="text-xs text-gray-500 mt-1">Leave blank to use post title</p>
                    </div>

                    <div class="mb-4">
                        <label class="form-label">SEO Description</label>
                        <textarea name="seo_description" id="seo_description" rows="3" class="form-input" maxlength="160">{{ old('seo_description') }}</textarea>
                        <p class="text-xs text-gray-500 mt-1">Max 160 characters</p>
                    </div>

                    <div>
                        <label class="form-label">SEO Keywords</label>
                        <input type="text" name="seo_keywords" id="seo_keywords" value="{{ old('seo_keywords') }}" class="form-input" placeholder="keyword1, keyword2">
                    </div>
                </div>
            </div>
        </div>
...
document.addEventListener('DOMContentLoaded', function() {
        ...
        switch(type) {
            case 'heading':
                content += `
                    ...
                    <input type="text" class="form-input" data-field="content" placeholder="Heading text">
                `;
                break;
            case 'text':
                content += `<textarea class="form-input" rows="5" data-field="content" placeholder="Rich text content (HTML supported)"></textarea>`;
                break;
            case 'image':
                content += `
                    <input type="text" class="form-input mb-2" data-field="url" placeholder="Image URL">
                    <input type="text" class="form-input mb-2" data-field="alt" placeholder="Alt text">
                    <input type="text" class="form-input" data-field="caption" placeholder="Caption (optional)">
                `;
                break;
            case 'quote':
                content += `
                    <textarea class="form-input mb-2" rows="3" data-field="content" placeholder="Quote text"></textarea>
                    <input type="text" class="form-input" data-field="author" placeholder="Author (optional)">
                `;
                break;
            case 'code':
                content += `
                    <input type="text" class="form-input mb-2" data-field="language" placeholder="Language (e.g., php, javascript)">
                    <textarea class="form-input font-mono text-sm" rows="8" data-field="content" placeholder="Code here"></textarea>
                `;
                break;
            case 'video':
                content += `
                    <input type="text" class="form-input mb-2" data-field="url" placeholder="Video URL (YouTube, Vimeo, etc.)">
            ...
            case 'callout':
                content += `
                    ...
                    <textarea class="form-input" rows="3" data-field="content" placeholder="Callout text"></textarea>
                `;
                break;
            case 'gallery':
                content += `
                    <textarea class="form-input" rows="5" data-field="images" placeholder="Image URLs, one per line"></textarea>
    ...
    function aiSEOGenerator() {
        return {
            ...
            async generateSEO() {                if (!this.prompt || this.prompt.trim().length < 10) {
                    this.error = 'Please provide a detailed prompt (at least 10 characters).';
                    return;
                }
                                this.loading = true;
                this.error = '';
