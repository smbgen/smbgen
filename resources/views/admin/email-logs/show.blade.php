...
<div class="space-y-6">
    ...
    <div class="flex justify-between items-center">
        <div>
            <h1 class="text-3xl font-bold text-gray-900 dark:text-gray-100">📧 Email Details</h1>
            <p class="text-gray-600 dark:text-gray-400">Tracking ID: {{ $emailLog->tracking_id }}</p>
        </div>
    ...
    <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div class="lg:col-span-2 space-y-6">
            ...
            <div class="card">
                <div class="bg-gray-100 dark:bg-gray-800 px-6 py-4 border-b border-gray-200 dark:border-gray-700">
                    <h3 class="text-lg font-semibold text-gray-900 dark:text-gray-100">Email Status</h3>
                </div>
                <div class="p-6">
                    ...
                    <div class="space-y-4">
                        <div class="grid grid-cols-2 gap-4">
                            <div>
                                <div class="text-sm text-gray-600 dark:text-gray-400">Sent At</div>
                                <div class="text-gray-900 dark:text-gray-100">
                                    {{ $emailLog->formatTimestamp($emailLog->sent_at) }}
                                </div>
                            </div>
                            <div>
                                <div class="text-sm text-gray-600 dark:text-gray-400">Delivered At</div>
                                <div class="text-gray-900 dark:text-gray-100">
                        ...
                        <div class="grid grid-cols-2 gap-4">
                            <div>
                                <div class="text-sm text-gray-600 dark:text-gray-400">First Opened</div>
                                <div class="text-gray-900 dark:text-gray-100">
                                    {{ $emailLog->formatTimestamp($emailLog->opened_at) }}
                                </div>
                            </div>
                            <div>
                                <div class="text-sm text-gray-600 dark:text-gray-400">Last Opened</div>
                                <div class="text-gray-900 dark:text-gray-100">
            ...
            <div class="card">
                <div class="bg-gray-100 dark:bg-gray-800 px-6 py-4 border-b border-gray-200 dark:border-gray-700">
                    <h3 class="text-lg font-semibold text-gray-900 dark:text-gray-100">Email Content</h3>
                </div>
                <div class="p-6">
                    <div class="space-y-4">
                        <div>
                            <div class="text-sm text-gray-600 dark:text-gray-400 mb-1">To</div>
                            <div class="text-gray-900 dark:text-gray-100">{{ $emailLog->to_email }}</div>
                        </div>

                        @if($emailLog->cc_email)
                            <div>
                                <div class="text-sm text-gray-600 dark:text-gray-400 mb-1">CC</div>
                                <div class="text-gray-900 dark:text-gray-100">{{ $emailLog->cc_email }}</div>
                            </div>
                        @endif

                        <div>
                            <div class="text-sm text-gray-600 dark:text-gray-400 mb-1">Subject</div>
                            <div class="text-gray-900 dark:text-gray-100 font-medium">{{ $emailLog->subject }}</div>
                        </div>

                        <div>
                            <div class="flex items-center justify-between mb-2">
                                <div class="text-sm text-gray-600 dark:text-gray-400">Message Body</div>
                                <div class="flex space-x-2">
                                    <button onclick="showRendered()" id="renderedBtn" class="px-3 py-1 text-xs bg-blue-600 text-white rounded hover:bg-blue-700">
                                        Rendered
                                    </button>
                                    <button onclick="showRaw()" id="rawBtn" class="px-3 py-1 text-xs bg-gray-200 dark:bg-gray-600 text-gray-800 dark:text-gray-300 rounded hover:bg-gray-300 dark:hover:bg-gray-700">
                                        Raw HTML
                                    </button>
                                    <button onclick="copyToClipboard()" id="copyBtn" class="px-3 py-1 text-xs bg-gray-200 dark:bg-gray-600 text-gray-800 dark:text-gray-300 rounded hover:bg-gray-300 dark:hover:bg-gray-700">
                            ...
                            <div id="rawView" class="hidden bg-gray-100 dark:bg-gray-800 rounded-lg p-4 border border-gray-300 dark:border-gray-700 overflow-x-auto max-h-[600px]">
                                <pre class="text-xs text-gray-700 dark:text-gray-300 whitespace-pre-wrap break-words" id="rawContent">{{ htmlspecialchars($emailLog->body) }}</pre>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            @if($emailLog->smtp_response || $emailLog->error_message)
                <div class="card">
                    <div class="bg-gray-100 dark:bg-gray-800 px-6 py-4 border-b border-gray-200 dark:border-gray-700">
                        <h3 class="text-lg font-semibold text-gray-900 dark:text-gray-100">Technical Details</h3>
                    </div>
                    <div class="p-6">
                        @if($emailLog->smtp_response)
                            <div class="mb-4">
                                <div class="text-sm text-gray-600 dark:text-gray-400 mb-1">SMTP Response</div>
                                <pre class="bg-gray-100 dark:bg-gray-800 rounded-lg p-4 text-xs text-green-600 dark:text-green-400 overflow-x-auto">{{ $emailLog->smtp_response }}</pre>
                            </div>
                        @endif
        ...
        <div class="space-y-6">
            ...
            <div class="card">
                <div class="bg-gray-100 dark:bg-gray-800 px-6 py-4 border-b border-gray-200 dark:border-gray-700">
                    <h3 class="text-lg font-semibold text-gray-900 dark:text-gray-100">Engagement</h3>
                </div>
                <div class="p-6 space-y-4">
                    <div class="flex items-center justify-between p-4 bg-green-900/20 rounded-lg">
                        <div>
                            <div class="text-2xl">📨</div>
                            <div class="text-sm text-gray-600 dark:text-gray-400 mt-1">Opens</div>
                        </div>
                    ...
                    <div class="flex items-center justify-between p-4 bg-purple-900/20 rounded-lg">
                        <div>
                            ...
                            <div class="text-sm text-gray-600 dark:text-gray-400 mt-1">Clicks</div>
                        </div>
            ...
            <div class="card">
                <div class="bg-gray-100 dark:bg-gray-800 px-6 py-4 border-b border-gray-200 dark:border-gray-700">
                    <h3 class="text-lg font-semibold text-gray-900 dark:text-gray-100">Associated Records</h3>
                </div>
                <div class="p-6 space-y-4">
                    @if($emailLog->user)
                        <div>
                            <div class="text-sm text-gray-600 dark:text-gray-400 mb-1">Sent By</div>
                            <div class="text-gray-900 dark:text-gray-100">{{ $emailLog->user->name ?? 'Unknown' }}</div>
            ...
            <div class="card">
                <div class="bg-gray-100 dark:bg-gray-800 px-6 py-4 border-b border-gray-200 dark:border-gray-700">
                    <h3 class="text-lg font-semibold text-gray-900 dark:text-gray-100">Tracking Info</h3>
                </div>
                <div class="p-6 space-y-3">
                    <div>
                        <div class="text-sm text-gray-600 dark:text-gray-400 mb-1">Tracking ID</div>
                        <div class="text-xs text-gray-700 dark:text-gray-300 font-mono bg-gray-100 dark:bg-gray-800 p-2 rounded">
                    ...
                    @if($emailLog->ip_address)
                        <div>
                            <div class="text-sm text-gray-600 dark:text-gray-400 mb-1">IP Address</div>
                            <div class="text-gray-900 dark:text-gray-100">{{ $emailLog->ip_address }}</div>
                        </div>
                    @endif
