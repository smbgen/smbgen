...
<div class="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
    ...
    <div class="flex justify-between items-center mb-6">
        <div>
            <h2 class="text-2xl font-bold text-gray-900 dark:text-gray-100">Files for {{ $client->name }}</h2>
            <p class="text-sm text-gray-600 dark:text-gray-400 mt-1">Manage documents and media files</p>
        </div>
                ...
                <table class="min-w-full divide-y divide-gray-200 dark:divide-gray-700">
                    <thead class="bg-gray-100 dark:bg-gray-900">
                        <tr>
                            ...
                            <th class="px-6 py-3 text-left text-xs font-medium text-gray-700 dark:text-gray-300 uppercase tracking-wider">Uploaded By</th>
