...
<div class="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
    ...
    <div class="flex justify-between items-center mb-6">
        <div>
            <h2 class="text-2xl font-bold text-gray-900 dark:text-gray-100">Files for {{ $user->name }}</h2>
            <p class="text-sm text-gray-600 dark:text-gray-400 mt-1">Manage personal documents and media files</p>
        </div>
        <a href="{{ route('admin.clients.files.overview') }}" class="btn-secondary">
            <i class="fas fa-arrow-left mr-2"></i>Back to File Management
        </a>
    </div>
    ...
    <div class="bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-lg shadow-lg mb-6">
        ...
        <div class="p-6">
            ...
            <form action="{{ route('admin.user.files.upload', $user) }}" method="POST" enctype="multipart/form-data">
                @csrf
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
                    ...
                    <div class="md:col-span-2">
                        ...
                        <input 
                            type="file" 
                            name="file" 
                            class="block w-full text-gray-700 dark:text-gray-200 file:mr-4 file:py-2 file:px-4 file:rounded-lg file:border-0 file:text-sm file:font-medium file:bg-blue-600 file:text-white hover:file:bg-blue-500 file:cursor-pointer border border-gray-300 dark:border-gray-700 rounded-lg bg-gray-50 dark:bg-gray-900/50 cursor-pointer" 
                            required 
                        />
                    ...
                    <div>
                        ...
                        <div class="flex items-center space-x-6">
                            <label class="flex items-center cursor-pointer group">
                                <input type="radio" name="is_public" value="0" checked class="w-4 h-4 text-blue-600 bg-white dark:bg-gray-700 border-gray-300 dark:border-gray-600 focus:ring-blue-500">
                            ...
                            <label class="flex items-center cursor-pointer group">
                                <input type="radio" name="is_public" value="1" class="w-4 h-4 text-blue-600 bg-white dark:bg-gray-700 border-gray-300 dark:border-gray-600 focus:ring-blue-500">
                                <span class="ml-2 text-sm text-gray-700 dark:text-gray-300 group-hover:text-gray-900 dark:group-hover:text-gray-100">
                    ...
                    <div>
                        ...
                        <textarea 
                            name="description" 
                            rows="3" 
                            class="w-full px-4 py-2 bg-white dark:bg-gray-700 border border-gray-300 dark:border-gray-600 rounded-lg text-gray-900 dark:text-gray-100 placeholder-gray-500 dark:placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-blue-500" 
    ...
    <div class="bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-lg shadow-md px-6 py-4 mb-6">
        <form method="GET" class="flex flex-wrap items-center gap-4">
            <div>
                ...
                <select name="visibility" class="px-4 py-2 bg-white dark:bg-gray-700 border border-gray-300 dark:border-gray-600 rounded-lg text-gray-900 dark:text-gray-100 text-sm focus:outline-none focus:ring-2 focus:ring-blue-500">
            ...
            <div>
                <label class="block text-xs font-medium text-gray-600 dark:text-gray-400 mb-1">File Type</label>
                <select name="category" class="px-4 py-2 bg-white dark:bg-gray-700 border border-gray-300 dark:border-gray-600 rounded-lg text-gray-900 dark:text-gray-100 text-sm focus:outline-none focus:ring-2 focus:ring-blue-500">
            ...
            @if(request('visibility') || request('category'))
                <div class="flex items-end">
                    <a href="{{ route('admin.user.files', $user) }}" class="btn-secondary text-sm">
                        Clear Filters
                    </a>
                </div>
            @endif
    ...
    <div class="bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-lg shadow-lg overflow-hidden">
            ...
            <div class="overflow-x-auto">
                <table class="min-w-full divide-y divide-gray-200 dark:divide-gray-700">
                    <thead class="bg-gray-100 dark:bg-gray-900">
                        <tr>
                            <th class="px-6 py-3 text-left text-xs font-medium text-gray-700 dark:text-gray-300 uppercase tracking-wider">File</th>
                            <th class="px-6 py-3 text-left text-xs font-medium text-gray-700 dark:text-gray-300 uppercase tracking-wider">Type</th>
                            <th class="px-6 py-3 text-left text-xs font-medium text-gray-700 dark:text-gray-300 uppercase tracking-wider">Size</th>
                            <th class="px-6 py-3 text-left text-xs font-medium text-gray-700 dark:text-gray-300 uppercase tracking-wider">Visibility</th>
                            <th class="px-6 py-3 text-left text-xs font-medium text-gray-700 dark:text-gray-300 uppercase tracking-wider">Uploaded</th>
                            ...
                            <tr class="hover:bg-gray-50 dark:hover:bg-gray-700/50 transition-colors">
                                ...
                                <td class="px-6 py-4">
                                    <div class="flex items-center">
                                        <i class="fas {{ $file->getFileIcon() }} text-indigo-400 text-xl mr-3"></i>
                                        <div>
                                            <div class="font-medium text-gray-900 dark:text-gray-100">{{ Str::limit($file->original_name, 40) }}</div>
                                            @if($file->description)
                                                <div class="text-xs text-gray-600 dark:text-gray-400 mt-1">{{ Str::limit($file->description, 50) }}</div>
                                            @endif
                                        </div>
                                    </div>
                                </td>
                                ...
                                <!-- Upload Date -->
                                <td class="px-6 py-4">
                                    <div class="text-gray-700 dark:text-gray-300 text-sm">{{ $file->created_at->format('M j, Y') }}</div>
                                ...
                                <td class="px-6 py-4 text-right">
                                    <div class="inline-flex gap-2">
                                        ...
                                        <a href="{{ route('admin.user.files.download', [$user, $file]) }}" class="inline-flex items-center px-3 py-1.5 text-xs font-medium text-blue-400 hover:text-blue-300 hover:bg-blue-900/20 rounded-lg transition-colors">
                                            <i class="fas fa-download mr-1"></i>Download
                                        </a>

                                        <form action="{{ route('admin.user.files.destroy', [$user, $file]) }}" method="POST" onsubmit="return confirm('Delete this file permanently?')" class="inline-block">
                                            @csrf
                                            @method('DELETE')
        ...
        @else
            <div class="text-center py-16">
                ...
                <h4 class="text-xl font-semibold text-gray-700 dark:text-gray-300 mb-2">No files found</h4>
                ...
                @if(request('visibility') || request('category'))
                    <a href="{{ route('admin.user.files', $user) }}" class="btn-secondary">
                        Clear Filters
                    </a>
                @endif
            </div>
