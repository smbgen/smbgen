...
<div class="max-w-4xl mx-auto py-6">
    ...
    <div class="bg-gray-800 rounded-lg shadow-xl p-6 mb-6">
        <div class="flex justify-between items-start mb-6">
            <div>
                <h2 class="text-2xl font-bold text-gray-100 mb-2">Booking Details</h2>
                @php
                    $statusColors = [
        ...
        <div class="mb-6">
            ...
            <div class="bg-gray-900/50 rounded-lg p-4 space-y-2">
                <div class="flex justify-between">
                    ...
                    <span class="text-gray-100 font-medium">{{ $booking->customer_name }}</span>
                </div>
                <div class="flex justify-between">
                ...
                @if($booking->property_address)
                    <div class="flex justify-between">
                        <span class="text-gray-400">Property Address:</span>
                        <span class="text-gray-100 text-right max-w-md">{{ $booking->property_address }}</span>
                    </div>
                @endif
            </div>
        </div>
        ...
        <div class="mb-6">
            ...
            <div class="bg-gray-900/50 rounded-lg p-4 space-y-2">
                <div class="flex justify-between">
                    ...
                    <span class="text-gray-100 font-medium">{{ $booking->booking_date->format('l, F j, Y') }}</span>
                </div>
                <div class="flex justify-between">
                    <span class="text-gray-400">Time:</span>
                    <span class="text-gray-100 font-medium">{{ $booking->starts_at->format('g:i A') }}</span>
                </div>
                <div class="flex justify-between">
                    <span class="text-gray-400">Duration:</span>
                    <span class="text-gray-100 font-medium">{{ $booking->duration }} minutes</span>
                </div>
                @if($booking->break_period_minutes)
                    <div class="flex justify-between">
                        <span class="text-gray-400">Break Period:</span>
                        <span class="text-gray-100">{{ $booking->break_period_minutes }} minutes</span>
                    </div>
                @endif
                @if($booking->staff)
                    <div class="flex justify-between">
                        <span class="text-gray-400">Assigned Staff:</span>
                        <span class="text-gray-100 font-medium">{{ $booking->staff->name }}</span>
                    </div>
                @endif
            </div>
        </div>
