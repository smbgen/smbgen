            ...
            <div class="lg:col-span-2 space-y-6">
                ...
                <div class="bg-gray-800/50 rounded-xl border border-gray-700 p-6">
                    ...
                    <div>
                        ...
                        <select name="user_id" required class="w-full bg-gray-900 text-gray-100 border border-gray-600 rounded-lg px-4 py-3 focus:ring-2 focus:ring-purple-500 focus:border-transparent" x-model="selectedClient" @change="updateClientInfo">
                        ...
                        <div x-show="selectedClient" x-cloak class="mt-3 p-3 bg-blue-900/20 border border-blue-800 rounded-lg">
                ...
                <div class="bg-gray-800/50 rounded-xl border border-gray-700 p-6">
                    ...
                    <div class="space-y-4">
                        <div>
                            <label class="block text-sm font-medium text-gray-300 mb-2">Memo / Notes</label>
                            <textarea name="memo" rows="2" class="w-full bg-gray-900 text-gray-100 border border-gray-600 rounded-lg px-4 py-3 focus:ring-2 focus:ring-purple-500 focus:border-transparent" placeholder="Optional notes for the invoice..."></textarea>
                        </div>
                        
                        <div class="grid grid-cols-2 gap-4">
                            <div>
                                <label class="block text-sm font-medium text-gray-300 mb-2">Due Date</label>
                                <input type="date" name="due_date" class="w-full bg-gray-900 text-gray-100 border border-gray-600 rounded-lg px-4 py-3 focus:ring-2 focus:ring-purple-500 focus:border-transparent" :min="new Date().toISOString().split('T')[0]">
                            </div>
                            <div>
                                <label class="block text-sm font-medium text-gray-300 mb-2">Status</label>
                                <select name="status" class="w-full bg-gray-900 text-gray-100 border border-gray-600 rounded-lg px-4 py-3 focus:ring-2 focus:ring-purple-500 focus:border-transparent">
                            ...
                            <div class="bg-gray-900/50 rounded-lg p-4 border border-gray-700">
                                <div class="grid grid-cols-12 gap-3">
                                    <div class="col-span-12 sm:col-span-6">
                                        ...
                                        <input type="text" :name="'items[' + index + '][description]'" x-model="item.description" required class="w-full bg-gray-800 text-gray-100 border border-gray-600 rounded-lg px-3 py-2 text-sm focus:ring-2 focus:ring-purple-500 focus:border-transparent" placeholder="Service or product description">
                                    </div>
                                    <div class="col-span-4 sm:col-span-2">
                                        <label class="block text-xs font-medium text-gray-400 mb-1">Qty *</label>
                                        <input type="number" :name="'items[' + index + '][quantity]'" x-model.number="item.quantity" @input="calculateItemTotal(index)" required min="1" class="w-full bg-gray-800 text-gray-100 border border-gray-600 rounded-lg px-3 py-2 text-sm focus:ring-2 focus:ring-purple-500 focus:border-transparent">
                                    </div>
                                    <div class="col-span-4 sm:col-span-2">
                                        <label class="block text-xs font-medium text-gray-400 mb-1">Price ($) *</label>
                                        <input type="number" :name="'items[' + index + '][unit_amount]'" x-model.number="item.unit_amount" @input="calculateItemTotal(index)" required min="0" step="0.01" class="w-full bg-gray-800 text-gray-100 border border-gray-600 rounded-lg px-3 py-2 text-sm focus:ring-2 focus:ring-purple-500 focus:border-transparent">
                                    </div>
                                    <div class="col-span-4 sm:col-span-2 flex items-end">
                                        <div class="w-full">
                                            <label class="block text-xs font-medium text-gray-400 mb-1">Total</label>
                                            <div class="bg-gray-700/50 border border-gray-600 rounded-lg px-3 py-2 text-sm text-gray-200 font-semibold" x-text="'$' + item.total.toFixed(2)"></div>
                                        </div>
                    ...
                    <div class="bg-gray-800/50 rounded-xl border border-gray-700 p-6">
                        ...
                        <div class="space-y-3">
                            <label class="flex items-start gap-3 cursor-pointer group">
                                <input type="checkbox" name="generate_payment_link" value="1" class="mt-1 w-4 h-4 text-purple-600 bg-gray-700 border-gray-600 rounded focus:ring-purple-500 focus:ring-2">
                                <div>
                                    <div class="text-sm font-medium text-gray-200 group-hover:text-white">Generate Stripe Payment Link</div>
                                    <div class="text-xs text-gray-400">Create a secure payment link for the client</div>
                                </div>
                            </label>
                            <label class="flex items-start gap-3 cursor-pointer group">
                                <input type="checkbox" name="send_email" value="1" class="mt-1 w-4 h-4 text-purple-600 bg-gray-700 border-gray-600 rounded focus:ring-purple-500 focus:ring-2">
                                <div>
                                    <div class="text-sm font-medium text-gray-200 group-hover:text-white">Email Invoice to Client</div>
                                    <div class="text-xs text-gray-400">Send invoice via email immediately</div>
                                </div>
                            </label>
                        </div>
                    </div>
