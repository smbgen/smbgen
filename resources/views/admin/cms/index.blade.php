...
<div class="py-6">
    ...
    <div class="admin-card mb-6" x-data="{ ...navbarBuilder(), navbarOpen: {{ session('open_navbar') ? 'true' : 'false' }} }">
        <button type="button" class="admin-card-header cursor-pointer hover:bg-gray-100 dark:hover:bg-gray-700/70 transition-colors w-full text-left" @click="navbarOpen = !navbarOpen">
            <div class="flex items-center justify-between">
                <div class="flex-1">
                    <h2 class="text-lg font-semibold text-gray-900 dark:text-white">Navigation Bar Settings</h2>
                    <p class="text-sm text-gray-600 dark:text-gray-400 mt-1">Configure the global navigation bar that appears on CMS pages</p>
                </div>
                <div class="ml-4">
                    <svg class="w-5 h-5 text-gray-600 dark:text-gray-400 transition-transform duration-200" :class="{ 'rotate-180': navbarOpen }" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 9l-7 7-7-7"></path>
                    </svg>
                </div>
            </div>
            ...
            <form action="{{ route('admin.cms.navbar.update') }}" method="POST" class="space-y-6">
                ...
                <div class="border-t border-gray-200 pt-4 dark:border-gray-700">
                    <div class="flex items-center mb-4">
                        ...
                        <label for="use_business_colors" class="ml-2 text-sm font-medium text-gray-700 dark:text-gray-300">
                            Use Company Colors
                            <span class="ml-1 text-xs text-gray-500 dark:text-gray-400">(from <a href="#company-colors" class="underline hover:text-blue-600 dark:hover:text-blue-400">Company Colors settings</a> below)</span>
                        </label>
                    </div>
                    ...
                    <div class="flex items-center mb-4">
                        <input type="checkbox" 
                               ...
                               class="rounded border-gray-300 text-blue-600 shadow-sm focus:ring-blue-500">
                        <label for="is_sticky" class="ml-2 text-sm font-medium text-gray-700 dark:text-gray-300">
                            Sticky Navbar
                            <span class="ml-1 text-xs text-gray-500 dark:text-gray-400">(Navbar stays at top of screen when scrolling)</span>
                        </label>
                    </div>
                        ...
                        <div>
                            ...
                            <div class="flex gap-3 items-center">
                                ...
                                <input type="text" 
                                       ...
                                       placeholder="#1f2937"
                                       pattern="^#[0-9A-Fa-f]{6}$">
                                <div class="w-12 h-12 rounded border-2 border-gray-300 dark:border-gray-600 shadow-sm" 
                                     :style="{ backgroundColor: bgColor }"></div>
                            </div>
                            <p class="text-xs text-gray-600 dark:text-gray-400 mt-1">Choose the background color for your navbar</p>
                        </div>
                        ...
                        <div>
                            ...
                            <div class="flex gap-3 items-center">
                                ...
                                <input type="text" 
                                       ...
                                       placeholder="#ffffff"
                                       pattern="^#[0-9A-Fa-f]{6}$">
                                <div class="w-12 h-12 rounded border-2 border-gray-300 dark:border-gray-600 shadow-sm flex items-center justify-center" 
                                     :style="{ backgroundColor: bgColor, color: textColor }">
                                    <span class="text-xs font-bold">Aa</span>
                                </div>
                            </div>
                            <p class="text-xs text-gray-600 dark:text-gray-400 mt-1">Choose the text/link color for your navbar</p>
                        </div>
                    </div>
                </div>
                ...
                <div class="border-t border-gray-200 pt-4 dark:border-gray-700">
                    <div class="flex items-center justify-between mb-4">
                        <div>
                            <h3 class="text-md font-semibold text-gray-900 dark:text-white">Menu Items</h3>
                    ...
                    <div class="space-y-3">
                        ...
                        <div x-show="menuItems.length === 0" class="text-center py-8 border-2 border-dashed border-gray-300 dark:border-gray-600 rounded-lg">
                            <i class="fa-solid fa-bars text-3xl text-gray-600 dark:text-gray-400 mb-2"></i>
    ...
    <div id="company-colors" class="admin-card mb-6" x-data="{ 
        ...
        <button type="button" class="admin-card-header cursor-pointer hover:bg-gray-100 dark:hover:bg-gray-700/70 transition-colors w-full text-left" @click="colorsOpen = !colorsOpen">
            <div class="flex items-center justify-between">
                <div class="flex-1">
                    <h2 class="text-lg font-semibold text-gray-900 dark:text-white flex items-center gap-2">Theme Settings</h2>
                    <p class="text-sm text-gray-600 dark:text-gray-400 mt-1">Choose a theme preset, customize colors, and enable effects for navbar, body, and footer</p>
                </div>
                <div class="ml-4">
                    <svg class="w-5 h-5 text-gray-600 dark:text-gray-400 transition-transform duration-200" :class="{ 'rotate-180': colorsOpen }" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 9l-7 7-7-7"></path>
                    </svg>
                </div>
            </div>
            ...
            <form action="{{ route('admin.cms.colors.update') }}" method="POST" class="space-y-6">
                ...
                <div class="border-t border-gray-200 pt-4 dark:border-gray-700">
                    ...
                    <div class="relative">
                        ...
                        <div id="css_preview_placeholder" class="absolute inset-0 flex items-center justify-center bg-gray-200 dark:bg-gray-900/50 backdrop-blur-sm z-10 cursor-pointer rounded-lg border border-gray-300 dark:border-gray-600" style="min-height: 300px;">
                            <div class="text-center">
                                <i class="fas fa-eye text-blue-400 text-3xl mb-2"></i>
                                <p class="text-blue-400 font-medium">Click to view generated CSS</p>
                                <p class="text-gray-600 dark:text-gray-400 text-sm mt-1">(Read-only preview)</p>
                            </div>
                        </div>
                    </div>
                    <div class="text-xs text-gray-600 dark:text-gray-400 mt-2 space-y-2 bg-gray-100 dark:bg-gray-800 rounded-lg p-3 border border-gray-300 dark:border-gray-700">
                        <p class="flex items-start gap-2">
                            <i class="fas fa-info-circle text-blue-400 mt-0.5 flex-shrink-0"></i>
                            <span>This CSS is <strong class="text-gray-900 dark:text-white">automatically generated</strong> from your theme colors and will be injected into all CMS pages.</span>
                        </p>
                        <p class="flex items-start gap-2">
                            <i class="fas fa-edit text-green-400 mt-0.5 flex-shrink-0"></i>
                            <span>To <strong class="text-gray-900 dark:text-white">override these styles</strong>, use the <strong class="text-gray-900 dark:text-white">Custom CSS</strong> editor in the CSS Editor tab above. Custom CSS loads after theme CSS and takes precedence.</span>
                        </p>
                        <p class="flex items-start gap-2">
                            <i class="fas fa-code text-purple-400 mt-0.5 flex-shrink-0"></i>
                            <span>Example: <code class="bg-gray-200 dark:bg-gray-900 px-2 py-1 rounded text-blue-700 dark:text-blue-300">.hero { background: linear-gradient(...); }</code></span>
                        </p>
                    </div>
                </div>
                ...
                <div class="mt-8 border-t border-gray-300 dark:border-gray-700 pt-6" 
                     x-data="{ activeTab: 'css-editor' }">
                    
                    {{-- Tab Navigation --}}
                    <div class="flex space-x-4 border-b border-gray-300 dark:border-gray-700 mb-6 overflow-x-auto">
                        <button type="button" 
                                @click="activeTab = 'css-editor'"
                                :class="activeTab === 'css-editor' ? 'border-blue-500 text-blue-700 dark:text-blue-300' : 'border-transparent text-gray-600 dark:text-gray-400'"
                        ...
                        <button type="button" 
                                ...
                                :class="activeTab === 'css-classes' ? 'border-blue-500 text-blue-700 dark:text-blue-300' : 'border-transparent text-gray-600 dark:text-gray-400'"
                                class="pb-3 px-4 border-b-2 font-medium transition-colors whitespace-nowrap">
                            <i class="fas fa-list mr-2"></i>CSS Class Whitelist
                        </button>
                        <button type="button" 
                                @click="activeTab = 'seo'"
                                :class="activeTab === 'seo' ? 'border-blue-500 text-blue-700 dark:text-blue-300' : 'border-transparent text-gray-600 dark:text-gray-400'"
                                class="pb-3 px-4 border-b-2 font-medium transition-colors whitespace-nowrap">
                    ...
                    <div x-show="activeTab === 'css-editor'" style="display: none;" x-transition>
                        <div class="space-y-4">
                            <div>
                                ...
                                <p class="text-sm text-gray-600 dark:text-gray-400 mb-3">Write custom CSS that will be injected into all CMS pages. This CSS will load after theme CSS.</p>
                                <textarea 
                                    name="custom_css" 
                                    id="custom_css_field"
                            ...
                            <div class="bg-yellow-50 dark:bg-yellow-900/20 border border-yellow-300 dark:border-yellow-600 rounded-lg p-4">
                                ...
                                <ul class="text-sm text-yellow-800 dark:text-yellow-200 space-y-1">
                                    <li>• Use CSS variables: <code class="rounded bg-gray-100 px-2 py-1 text-gray-900 dark:bg-gray-800 dark:text-gray-100">var(--brand-primary)</code></li>
                                    <li>• Define semantic classes for AI: <code class="rounded bg-gray-100 px-2 py-1 text-gray-900 dark:bg-gray-800 dark:text-gray-100">.hero</code>, <code class="rounded bg-gray-100 px-2 py-1 text-gray-900 dark:bg-gray-800 dark:text-gray-100">.section</code>, <code class="rounded bg-gray-100 px-2 py-1 text-gray-900 dark:bg-gray-800 dark:text-gray-100">.cta-button</code></li>
                        ...
                        <div class="space-y-4" x-data="{ 
                            ...
                            <div class="bg-blue-50 dark:bg-blue-900/20 border border-blue-200 dark:border-blue-600 rounded-lg p-4">
                                ...
                                <div class="text-sm text-blue-700 dark:text-blue-200 space-y-2">
                                    ...
                                    <p>
                                        You can add custom semantic classes (like <code class="bg-gray-100 dark:bg-gray-800 px-2 py-1 rounded">hero</code>, <code class="bg-gray-100 dark:bg-gray-800 px-2 py-1 rounded">section</code>) 
                                        or Tailwind utility classes (like <code class="bg-gray-100 dark:bg-gray-800 px-2 py-1 rounded">grid</code>, <code class="bg-gray-100 dark:bg-gray-800 px-2 py-1 rounded">p-4</code>).
                                    </p>
                                    <p>
                                        <a href="https://tailwindcss.com/docs" target="_blank" class="text-blue-700 underline hover:text-blue-900 dark:text-blue-300 dark:hover:text-blue-200">
                            ...
                            <div>
                                ...
                                <div class="space-y-2">
                                    <template x-for="(cssClass, index) in classes" :key="index">
                                        <div class="flex items-center justify-between bg-gray-100 dark:bg-gray-800 rounded-lg p-3 border border-gray-300 dark:border-gray-700">
                                            <code class="text-blue-700 dark:text-blue-300" x-text="cssClass"></code>
                                            <button 
                                                type="button" 
                                    ...
                                    <div x-show="classes.length === 0" class="text-gray-600 dark:text-gray-400 text-sm text-center py-8">
                        ...
                        <div class="space-y-6">
                            ...
                            <div>
                                ...
                                <input type="text" 
                                       ...
                                       class="form-input">
                                <p class="text-xs text-gray-600 dark:text-gray-400 mt-1">Use <code class="bg-gray-100 dark:bg-gray-800 px-1 rounded">{page_title}</code> placeholder</p>
                            </div>
                            ...
                            <div>
                                ...
                                <p class="text-xs text-gray-600 dark:text-gray-400 mt-1">Recommended: 150-160 characters</p>
                            </div>
                            ...
                            <div>
                                ...
                                <input type="text" 
                                       ...
                                       class="form-input">
                                <p class="text-xs text-gray-600 dark:text-gray-400 mt-1">Comma-separated list</p>
                            </div>

                            <hr class="border-gray-300 dark:border-gray-700">

                            {{-- Open Graph Settings --}}
                            <h3 class="text-lg font-semibold text-gray-900 dark:text-white">Open Graph (Facebook, LinkedIn)</h3>
                            ...
                            <div>
                                ...
                                <input type="url" 
                                       ...
                                       class="form-input">
                                <p class="text-xs text-gray-600 dark:text-gray-400 mt-1">Recommended: 1200x630px</p>
                            </div>
                            ...
                            <div>
                                ...
                                <p class="text-sm text-gray-600 dark:text-gray-400 mb-2">Additional scripts or styles to inject in <code class="bg-gray-100 dark:bg-gray-800 px-1 rounded">&lt;head&gt;</code></p>
                                <textarea 
                                ...
                                <p class="text-xs text-gray-600 dark:text-gray-400 mt-1">Example: Google Analytics, custom fonts, etc.</p>
                            </div>
                        </div>
                    </div>
                </div>
    ...
    <div class="admin-card mb-6" x-data="{ footerOpen: {{ session('open_footer') ? 'true' : 'false' }} }" x-init="$watch('footerOpen', value => { if (value && window.footerEditor) { setTimeout(() => window.footerEditor.refresh(), 100); } })">
        <button type="button" class="admin-card-header cursor-pointer hover:bg-gray-100 dark:hover:bg-gray-700/70 transition-colors w-full text-left" @click="footerOpen = !footerOpen">
            <div class="flex items-center justify-between">
                <div class="flex-1">
                    <h2 class="text-lg font-semibold text-gray-900 dark:text-white">Footer Settings</h2>
                    <p class="text-sm text-gray-600 dark:text-gray-400 mt-1">Configure the global footer that appears on all public pages</p>
                </div>
                <div class="ml-4">
                    <svg class="w-5 h-5 text-gray-600 dark:text-gray-400 transition-transform duration-200" :class="{ 'rotate-180': footerOpen }" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 9l-7 7-7-7"></path>
                    </svg>
                </div>
            </div>
        ...
        <div class="admin-card-body" x-show="footerOpen" x-collapse>
            <form action="{{ route('admin.cms.footer.update') }}" method="POST" class="space-y-6">
                ...
                <div class="flex items-center mb-4">
                    ...
                    <label for="use_default_footer" class="ml-2 text-sm text-gray-700 dark:text-gray-300">
                ...
                <div>
                    ...
                    <p class="text-sm text-gray-600 dark:text-gray-400 mb-2">Customize your footer HTML. The default template includes Quick Links and social media icons.</p>
                    <textarea 
                        id="footer_html" 
                        name="footer_html" 
                        rows="15"
                ...
                <div class="bg-gray-100 dark:bg-gray-800 border border-gray-300 dark:border-gray-700 rounded-lg p-4">
                    <h3 class="text-sm font-semibold text-gray-900 dark:text-white mb-2">Available Variables</h3>
                    <ul class="text-sm text-gray-600 dark:text-gray-400 space-y-1">
                        <li><code class="text-blue-700 dark:text-blue-300">{{ '{{' }} config('business.company_name') }}</code> - Company name</li>
                        <li><code class="text-blue-700 dark:text-blue-300">{{ '{{' }} config('business.tagline') }}</code> - Company tagline</li>
                        <li><code class="text-blue-700 dark:text-blue-300">{{ '{{' }} config('business.social.twitter') }}</code> - Twitter URL</li>
                        <li><code class="text-blue-700 dark:text-blue-300">{{ '{{' }} config('business.social.facebook') }}</code> - Facebook URL</li>
                        <li><code class="text-blue-700 dark:text-blue-300">{{ '{{' }} config('business.social.linkedin') }}</code> - LinkedIn URL</li>
                        <li><code class="text-blue-700 dark:text-blue-300">{{ '{{' }} date('Y') }}</code> - Current year</li>
                    </ul>
                </div>
                            ...
                            <table class="admin-table">
                                <thead>
                                    <tr>
                                        <th>
                                            Slug
                                            <span class="ml-2 text-xs font-semibold text-blue-700 dark:text-blue-300">Page with slug <code class="rounded bg-gray-100 px-1 text-gray-900 dark:bg-gray-800 dark:text-gray-100">home</code> becomes the Homepage of your website</span>
                                        </th>
                                        <th>
                                            Title
                                        </th>
    ...
    <div class="admin-card mt-6" x-data="{ docsOpen: false }">
        <button type="button" class="admin-card-header cursor-pointer hover:bg-gray-100 dark:hover:bg-gray-700/70 transition-colors w-full text-left" @click="docsOpen = !docsOpen">
            <div class="flex items-center justify-between">
                <div class="flex-1">
                    ...
                    <p class="text-sm text-gray-600 dark:text-gray-400 mt-1">Learn how to use the CMS system and available features</p>
                </div>
                <div class="ml-4">
                    <svg class="w-5 h-5 text-gray-600 dark:text-gray-400 transition-transform duration-200" :class="{ 'rotate-180': docsOpen }" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 9l-7 7-7-7"></path>
                    </svg>
                </div>
            </div>
            ...
            <div class="prose dark:prose-invert max-w-none space-y-6">
                ...
                <div class="bg-gradient-to-r from-blue-900/30 to-purple-900/30 border border-blue-600 rounded-lg p-6">
                    ...
                    <p class="text-gray-800 dark:text-gray-200 mb-4">
                        This CMS is designed to be <strong class="text-blue-700 dark:text-blue-300">opinionated yet flexible</strong>. It provides sensible defaults and structures 
                ...
                {{-- Page Structure --}}
                <div class="bg-gray-100 dark:bg-gray-800 border border-gray-300 dark:border-gray-700 rounded-lg p-6">
                    <h3 class="text-lg font-bold text-gray-900 dark:text-white mb-4 flex items-center gap-2">
                        <i class="fas fa-layer-group text-purple-400"></i>
                        Page Structure
                    </h3>
                    <p class="text-gray-700 dark:text-gray-300 mb-4">Each CMS page has three main content areas:</p>
                    
                    <div class="space-y-4">
                        <div class="bg-gray-200 dark:bg-gray-900 rounded-lg p-4 border-l-4 border-blue-500">
                            <h4 class="font-semibold text-blue-700 dark:text-blue-300 mb-2">
                                <i class="fas fa-code mr-2"></i>Head Content
                            </h4>
                            <p class="text-sm text-gray-600 dark:text-gray-400 mb-2">
                                Loads in the <code class="bg-gray-100 dark:bg-gray-800 px-2 py-1 rounded text-blue-700 dark:text-blue-300">&lt;head&gt;</code> section. Perfect for:
                            </p>
                            <ul class="text-sm text-gray-600 dark:text-gray-400 space-y-1 ml-6">
                                <li>• Custom <code class="bg-gray-100 dark:bg-gray-800 px-1 rounded">&lt;style&gt;</code> tags with CSS</li>
                                <li>• External stylesheets with <code class="bg-gray-100 dark:bg-gray-800 px-1 rounded">&lt;link&gt;</code></li>
                                <li>• Meta tags for SEO</li>
                                <li>• Scripts that don't need DOM access (analytics, config)</li>
                            </ul>
                        </div>

                        <div class="bg-gray-200 dark:bg-gray-900 rounded-lg p-4 border-l-4 border-green-500">
                        ...
                        <div class="bg-gray-200 dark:bg-gray-900 rounded-lg p-4 border-l-4 border-orange-500">
                            <h4 class="font-semibold text-orange-700 dark:text-orange-300 mb-2">
                                <i class="fas fa-terminal mr-2"></i>Footer Scripts
                            </h4>
                            <p class="text-sm text-gray-600 dark:text-gray-400 mb-2">
                                Loads before <code class="bg-gray-100 dark:bg-gray-800 px-2 py-1 rounded text-orange-700 dark:text-orange-300">&lt;/body&gt;</code>. Best for:
                            </p>
                            <ul class="text-sm text-gray-600 dark:text-gray-400 space-y-1 ml-6">
                                <li>• Scripts that need DOM access (animations, interactions)</li>
                                <li>• Canvas/WebGL scripts</li>
                                <li>• Page-specific JavaScript</li>
                                <li>• No <code class="bg-gray-100 dark:bg-gray-800 px-1 rounded">DOMContentLoaded</code> wrapper needed - DOM is ready!</li>
                            </ul>
                            <div class="mt-3 bg-yellow-50 dark:bg-yellow-900/30 border border-yellow-300 dark:border-yellow-600 rounded p-3">
                ...
                <div class="bg-red-900/20 border border-red-600 rounded-lg p-6">
                    ...
                    <div class="bg-gray-200 dark:bg-gray-900 rounded-lg p-4 mb-4">
                        <h4 class="font-semibold text-gray-900 dark:text-white mb-2">How It Works</h4>
                        <ul class="text-sm text-gray-600 dark:text-gray-400 space-y-2">
                            <li class="flex items-start gap-2">
                                <i class="fas fa-check text-green-400 mt-1"></i>
                                <span>Allows safe HTML tags: <code class="bg-gray-100 dark:bg-gray-800 px-1 rounded">div, span, p, h1-h6, img, a, table, form, canvas, svg</code> and more</span>
                            </li>
                            <li class="flex items-start gap-2">
                                <i class="fas fa-check text-green-400 mt-1"></i>
                                <span>Preserves <code class="bg-gray-100 dark:bg-gray-800 px-1 rounded">&lt;style&gt;</code> and <code class="bg-gray-100 dark:bg-gray-800 px-1 rounded">&lt;script&gt;</code> tags completely intact</span>
                            </li>
                            <li class="flex items-start gap-2">
                                <i class="fas fa-check text-green-400 mt-1"></i>
                    ...
                    <div class="bg-yellow-50 dark:bg-yellow-900/30 border border-yellow-300 dark:border-yellow-600 rounded p-4">
                ...
                <div class="bg-gradient-to-r from-cyan-900/30 to-blue-900/30 border border-cyan-600 rounded-lg p-6">
                    ...
                    <div class="grid grid-cols-1 lg:grid-cols-2 gap-4 mb-4">
                        <div class="bg-gray-200 dark:bg-gray-900 rounded-lg p-4">
                            <h4 class="font-semibold text-gray-900 dark:text-white mb-3">Common Layout Classes</h4>
                            <div class="space-y-2 text-sm">
                                <div class="flex items-center gap-2">
                                    <code class="bg-gray-100 dark:bg-gray-800 px-2 py-1 rounded text-blue-700 dark:text-blue-300 flex-1">container mx-auto</code>
                                    <span class="text-gray-600 dark:text-gray-400 text-xs">Centered container</span>
                                </div>
                                <div class="flex items-center gap-2">
                                    <code class="bg-gray-100 dark:bg-gray-800 px-2 py-1 rounded text-blue-700 dark:text-blue-300 flex-1">flex justify-center items-center</code>
                                    <span class="text-gray-600 dark:text-gray-400 text-xs">Center content</span>
                                </div>
                                <div class="flex items-center gap-2">
                                    <code class="bg-gray-100 dark:bg-gray-800 px-2 py-1 rounded text-blue-700 dark:text-blue-300 flex-1">grid grid-cols-3 gap-4</code>
                                    <span class="text-gray-600 dark:text-gray-400 text-xs">3-column grid</span>
                                </div>
                                <div class="flex items-center gap-2">
                                    <code class="bg-gray-100 dark:bg-gray-800 px-2 py-1 rounded text-blue-700 dark:text-blue-300 flex-1">p-4 md:p-8</code>
                                    <span class="text-gray-600 dark:text-gray-400 text-xs">Responsive padding</span>
                                </div>
                            </div>
                        </div>

                        <div class="bg-gray-200 dark:bg-gray-900 rounded-lg p-4">
                            <h4 class="font-semibold text-gray-900 dark:text-white mb-3">Theme Colors</h4>
                            <div class="space-y-2 text-sm">
                                <div class="flex items-center gap-2">
                                    <code class="bg-gray-100 dark:bg-gray-800 px-2 py-1 rounded text-blue-700 dark:text-blue-300 flex-1">text-brand</code>
                                    <span class="text-gray-600 dark:text-gray-400 text-xs">Primary brand color</span>
                                </div>
                                <div class="flex items-center gap-2">
                                    <code class="bg-gray-100 dark:bg-gray-800 px-2 py-1 rounded text-blue-700 dark:text-blue-300 flex-1">bg-brand</code>
                                    <span class="text-gray-600 dark:text-gray-400 text-xs">Primary background</span>
                                </div>
                                <div class="flex items-center gap-2">
                                    <code class="bg-gray-100 dark:bg-gray-800 px-2 py-1 rounded text-blue-700 dark:text-blue-300 flex-1">text-accent</code>
                                    <span class="text-gray-600 dark:text-gray-400 text-xs">Accent color text</span>
                                </div>
                                <div class="flex items-center gap-2">
                                    <code class="bg-gray-100 dark:bg-gray-800 px-2 py-1 rounded text-blue-700 dark:text-blue-300 flex-1">bg-accent</code>
                                    <span class="text-gray-600 dark:text-gray-400 text-xs">Accent background</span>
                                </div>
                            </div>
                        </div>

                        <div class="bg-gray-200 dark:bg-gray-900 rounded-lg p-4">
                            <h4 class="font-semibold text-gray-900 dark:text-white mb-3">Button Styles</h4>
                            <div class="space-y-2 text-sm">
                                <div class="flex items-center gap-2">
                                    <code class="bg-gray-100 dark:bg-gray-800 px-2 py-1 rounded text-blue-700 dark:text-blue-300 flex-1">btn-primary</code>
                                    <span class="text-gray-600 dark:text-gray-400 text-xs">Primary button</span>
                                </div>
                                <div class="flex items-center gap-2">
                                    <code class="bg-gray-100 dark:bg-gray-800 px-2 py-1 rounded text-blue-700 dark:text-blue-300 flex-1">btn-secondary</code>
                                    <span class="text-gray-600 dark:text-gray-400 text-xs">Secondary button</span>
                                </div>
                                <div class="flex items-center gap-2">
                                    <code class="bg-gray-100 dark:bg-gray-800 px-2 py-1 rounded text-blue-700 dark:text-blue-300 flex-1">btn-accent</code>
                                    <span class="text-gray-600 dark:text-gray-400 text-xs">Accent button</span>
                                </div>
                                <div class="flex items-center gap-2">
                                    <code class="bg-gray-100 dark:bg-gray-800 px-2 py-1 rounded text-blue-700 dark:text-blue-300 flex-1">btn-success</code>
                                    <span class="text-gray-600 dark:text-gray-400 text-xs">Green success button</span>
                                </div>
                            </div>
                        </div>

                        <div class="bg-gray-200 dark:bg-gray-900 rounded-lg p-4">
                            <h4 class="font-semibold text-gray-900 dark:text-white mb-3">Typography</h4>
                            <div class="space-y-2 text-sm">
                                <div class="flex items-center gap-2">
                                    <code class="bg-gray-100 dark:bg-gray-800 px-2 py-1 rounded text-blue-700 dark:text-blue-300 flex-1">text-xs sm md lg xl 2xl</code>
                                    <span class="text-gray-600 dark:text-gray-400 text-xs">Font sizes</span>
                                </div>
                                <div class="flex items-center gap-2">
                                    <code class="bg-gray-100 dark:bg-gray-800 px-2 py-1 rounded text-blue-700 dark:text-blue-300 flex-1">font-bold font-semibold</code>
                                    <span class="text-gray-600 dark:text-gray-400 text-xs">Font weights</span>
                                </div>
                                <div class="flex items-center gap-2">
                                    <code class="bg-gray-100 dark:bg-gray-800 px-2 py-1 rounded text-blue-700 dark:text-blue-300 flex-1">text-center text-left</code>
                                    <span class="text-gray-600 dark:text-gray-400 text-xs">Alignment</span>
                                </div>
                                <div class="flex items-center gap-2">
                                    <code class="bg-gray-100 dark:bg-gray-800 px-2 py-1 rounded text-blue-700 dark:text-blue-300 flex-1">leading-tight leading-loose</code>
                                    <span class="text-gray-600 dark:text-gray-400 text-xs">Line height</span>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="flex items-center gap-3 bg-blue-900/30 border border-blue-600 rounded p-4">
                        ...
                        <div class="flex-1">
                            <p class="text-gray-900 dark:text-white font-semibold mb-1">Full Tailwind Documentation</p>
                            <a href="https://tailwindcss.com/docs" target="_blank" class="text-blue-700 dark:text-blue-300 hover:text-blue-200 text-sm underline">
                ...
                <div class="bg-gray-100 dark:bg-gray-800 border border-gray-300 dark:border-gray-700 rounded-lg p-6">
                    ...
                    <div class="bg-gray-200 dark:bg-gray-900 rounded-lg p-4 font-mono text-sm">
                        <div class="space-y-1 text-gray-700 dark:text-gray-300">
                            <div class="flex items-center gap-3">
                                <code class="text-blue-700 dark:text-blue-300">--brand-primary</code>
                                <span class="text-gray-500">→</span>
                                <span class="text-gray-600 dark:text-gray-400">Primary brand color</span>
                            </div>
                            <div class="flex items-center gap-3">
                                <code class="text-blue-700 dark:text-blue-300">--brand-secondary</code>
                                <span class="text-gray-500">→</span>
                                <span class="text-gray-600 dark:text-gray-400">Secondary brand color</span>
                            </div>
                            <div class="flex items-center gap-3">
                                <code class="text-blue-700 dark:text-blue-300">--brand-accent</code>
                                <span class="text-gray-500">→</span>
                                <span class="text-gray-600 dark:text-gray-400">Accent color</span>
                            </div>
                            <div class="flex items-center gap-3">
                                <code class="text-blue-700 dark:text-blue-300">--brand-bg</code>
                                <span class="text-gray-500">→</span>
                                <span class="text-gray-600 dark:text-gray-400">Background color</span>
                            </div>
                            <div class="flex items-center gap-3">
                                <code class="text-blue-700 dark:text-blue-300">--brand-text</code>
                                <span class="text-gray-500">→</span>
                                <span class="text-gray-600 dark:text-gray-400">Text color</span>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="mt-4 bg-green-900/20 border border-green-600 rounded p-4">
                        ...
                        <pre class="bg-gray-200 dark:bg-gray-900 rounded p-3 text-xs text-gray-700 dark:text-gray-300 overflow-x-auto"><code>.my-custom-button {
                ...
                <div class="bg-gradient-to-r from-green-900/30 to-emerald-900/30 border border-green-600 rounded-lg p-6">
                    ...
                    <div class="space-y-4">
                        <div class="flex items-start gap-3">
                            <i class="fas fa-check-circle text-green-400 mt-1"></i>
                            <div class="flex-1">
                                <h4 class="font-semibold text-gray-900 dark:text-white mb-1">Use Semantic HTML</h4>
                                <p class="text-sm text-gray-700 dark:text-gray-300">Use <code class="bg-gray-100 dark:bg-gray-800 px-1 rounded">&lt;header&gt;</code>, <code class="bg-gray-100 dark:bg-gray-800 px-1 rounded">&lt;main&gt;</code>, <code class="bg-gray-100 dark:bg-gray-800 px-1 rounded">&lt;section&gt;</code>, <code class="bg-gray-100 dark:bg-gray-800 px-1 rounded">&lt;article&gt;</code> for better accessibility and SEO.</p>
                            </div>
                        </div>
                        ...
                        <div class="flex items-start gap-3">
                            <i class="fas fa-check-circle text-green-400 mt-1"></i>
                            <div class="flex-1">
                                <h4 class="font-semibold text-gray-900 dark:text-white mb-1">Separate Concerns</h4>
                                <p class="text-sm text-gray-700 dark:text-gray-300">Put styles in Head Content, HTML in Body Content, and DOM-dependent scripts in Footer Scripts.</p>
                            </div>
                        </div>
                        ...
                        <div class="flex items-start gap-3">
                            <i class="fas fa-check-circle text-green-400 mt-1"></i>
                            <div class="flex-1">
                                <h4 class="font-semibold text-gray-900 dark:text-white mb-1">Use Theme Colors</h4>
                                <p class="text-sm text-gray-700 dark:text-gray-300">Prefer <code class="bg-gray-100 dark:bg-gray-800 px-1 rounded">btn-primary</code> and CSS variables over hardcoded colors for consistent branding.</p>
                            </div>
                        </div>
                        ...
                        <div class="flex items-start gap-3">
                            <i class="fas fa-check-circle text-green-400 mt-1"></i>
                            <div class="flex-1">
                                <h4 class="font-semibold text-gray-900 dark:text-white mb-1">Test Responsiveness</h4>
                                <p class="text-sm text-gray-700 dark:text-gray-300">Use Tailwind's responsive prefixes (<code class="bg-gray-100 dark:bg-gray-800 px-1 rounded">md:</code>, <code class="bg-gray-100 dark:bg-gray-800 px-1 rounded">lg:</code>) to ensure pages look good on all devices.</p>
                            </div>
                        </div>
                        ...
                        <div class="flex items-start gap-3">
                            <i class="fas fa-check-circle text-green-400 mt-1"></i>
                            <div class="flex-1">
                                <h4 class="font-semibold text-gray-900 dark:text-white mb-1">Leverage Footer Scripts</h4>
                                <p class="text-sm text-gray-700 dark:text-gray-300">Move DOM-dependent JavaScript to Footer Scripts to avoid timing issues and eliminate the need for <code class="bg-gray-100 dark:bg-gray-800 px-1 rounded">DOMContentLoaded</code> wrappers.</p>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="bg-gray-100 dark:bg-gray-800 border border-gray-300 dark:border-gray-700 rounded-lg p-6">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                        <div class="bg-gray-200 dark:bg-gray-900 rounded p-4">
                            ...
                            <p class="text-sm text-gray-600 dark:text-gray-400">Add CSS in <strong>Head Content</strong> or use <strong>Theme Settings → CSS Editor</strong> for global styles.</p>
                        </div>
                        ...
                        <div class="bg-gray-200 dark:bg-gray-900 rounded p-4">
                            ...
                            <p class="text-sm text-gray-600 dark:text-gray-400">Move scripts to <strong>Footer Scripts</strong> if they need DOM access. The DOM is ready there!</p>
                        </div>
                        ...
                        <div class="bg-gray-200 dark:bg-gray-900 rounded p-4">
                            ...
                            <p class="text-sm text-gray-600 dark:text-gray-400">Canvas, WebGL, and CSS animations work great in <strong>Footer Scripts</strong>.</p>
                        </div>
                        ...
                        <div class="bg-gray-200 dark:bg-gray-900 rounded p-4">
                            ...
                            <p class="text-sm text-gray-600 dark:text-gray-400">Use <strong>Theme Settings</strong> to set brand colors and apply them with <code class="bg-gray-100 dark:bg-gray-800 px-1 rounded">.btn-primary</code>, <code class="bg-gray-100 dark:bg-gray-800 px-1 rounded">.text-brand</code>, etc.</p>
                        </div>
                    </div>
                </div>
