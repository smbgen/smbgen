...
<div class="px-4 sm:px-6 lg:px-8 py-6">
    ...
    <div class="flex justify-between items-center mb-6">
        <div>
            <h2 class="text-2xl font-bold text-gray-100">CMS Images</h2>
            <p class="text-sm text-gray-400 mt-1">Manage images for use in CMS content</p>
        </div>
    ...
    <div class="grid grid-cols-1 md:grid-cols-4 gap-4 mb-6">
        <div class="bg-gray-800 border border-gray-700 rounded-lg p-4">
            <div class="flex items-center justify-between">
                <div>
                    <p class="text-xs text-gray-400">Total Images</p>
                    <p class="text-2xl font-bold text-gray-100 mt-1">{{ \App\Models\CmsImage::count() }}</p>
                </div>
        ...
        <div class="bg-gray-800 border border-gray-700 rounded-lg p-4">
            <div class="flex items-center justify-between">
                <div>
                    <p class="text-xs text-gray-400">Recent Uploads</p>
                    <p class="text-2xl font-bold text-gray-100 mt-1">{{ \App\Models\CmsImage::where('created_at', '>=', now()->subWeek())->count() }}</p>
        ...
        <div class="bg-gray-800 border border-gray-700 rounded-lg p-4">
            <div class="flex items-center justify-between">
                <div>
                    <p class="text-xs text-gray-400">Avg. File Size</p>
                    <p class="text-2xl font-bold text-gray-100 mt-1">
                        @php
        ...
        <div class="flex flex-wrap items-center justify-between gap-4">
                ...
                <form method="GET" class="flex flex-wrap items-center gap-4">
                    <div>
                        ...
                        <input type="text" name="search" value="{{ request('search') }}"
                               class="px-4 py-2 bg-gray-700 border border-gray-600 rounded-lg text-gray-100 text-sm focus:outline-none focus:ring-2 focus:ring-blue-500"
                               placeholder="Search images...">
                    </div>

                    <div>
                        <label class="block text-xs font-medium text-gray-400 mb-1">Sort By</label>
                        <select name="sort" class="px-4 py-2 bg-gray-700 border border-gray-600 rounded-lg text-gray-100 text-sm focus:outline-none focus:ring-2 focus:ring-blue-500">
            ...
            <div class="flex items-center space-x-4">
                ...
                <div class="flex items-center space-x-2">
                    ...
                    <button onclick="setViewMode('list')" id="listViewBtn" class="p-2 rounded-lg bg-gray-600 hover:bg-gray-500 text-gray-300">
    ...
    <div class="bg-gray-800 border border-gray-700 rounded-lg shadow-lg overflow-hidden">
            ...
            <div class="p-6">
                <div class="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 xl:grid-cols-6 gap-6">
                    @foreach($images as $image)
                        <div class="relative bg-gray-700 rounded-lg overflow-hidden border border-gray-600 hover:border-blue-500 transition-colors group image-card" data-image-id="{{ $image->id }}">
                            <!-- Checkbox Overlay -->
                            <div class="absolute top-2 left-2 z-10">
                                <input type="checkbox" 
                                       class="image-checkbox w-5 h-5 text-blue-600 bg-gray-700 border-gray-500 rounded focus:ring-blue-500 focus:ring-2 cursor-pointer"
                                       value="{{ $image->id }}"
                                       onchange="updateBulkDeleteButton()"
                                       onclick="event.stopPropagation();">
                            </div>
                            <!-- Image -->
                            <div class="aspect-square bg-gray-600 flex items-center justify-center overflow-hidden relative cursor-pointer"
                            ...
                            <!-- Info -->
                            <div class="p-3">
                                <h4 class="text-sm font-medium text-gray-100 truncate" title="{{ $image->original_name }}">
                                ...
                                @if($image->alt_text)
                                    <p class="text-xs text-gray-500 mt-1 truncate" title="{{ $image->alt_text }}">
                                ...
                                <div class="mt-2">
                                    <input type="text" 
                                           ...
                                           class="w-full px-2 py-1 text-xs bg-gray-800 border border-gray-600 rounded text-gray-300 focus:outline-none focus:ring-1 focus:ring-blue-500 cursor-pointer hover:border-blue-500"
                                           title="Click to copy URL">
                                </div>
        ...
        @else
            <div class="text-center py-16">
                ...
                <h4 class="text-xl font-semibold text-gray-300 mb-2">No images found</h4>
...
<div id="insertImageModal" class="fixed inset-0 bg-black bg-opacity-50 hidden z-50">
    <div class="flex items-center justify-center min-h-screen p-4">
        <div class="bg-gray-800 rounded-lg max-w-md w-full p-6">
            <h3 class="text-lg font-semibold text-gray-100 mb-4">Insert Image</h3>
            <p class="text-sm text-gray-400 mb-4">Choose how to insert this image:</p>

            <div class="space-y-3">
                <button id="insertHtmlBtn" class="w-full text-left p-3 bg-gray-700 hover:bg-gray-600 rounded-lg transition-colors">
                    <div class="font-medium text-gray-100">HTML</div>
                    <div class="text-xs text-gray-400 mt-1">Insert as &lt;img&gt; tag</div>
                </button>

                <button id="insertMarkdownBtn" class="w-full text-left p-3 bg-gray-700 hover:bg-gray-600 rounded-lg transition-colors">
                    <div class="font-medium text-gray-100">Markdown</div>
                    <div class="text-xs text-gray-400 mt-1">Insert as ![alt](url) syntax</div>
                </button>
            </div>
