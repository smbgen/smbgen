...
<div x-data="{}">
    <div class="flex justify-between items-center mb-6">
        <div>
            <h2 class="font-semibold text-2xl text-gray-100 leading-tight">
                Edit CMS Page: {{ $cmsPage->title }}
            </h2>
            <p class="text-gray-400 text-sm mt-1">Update page content and settings</p>
        </div>
    ...
    <div>
        ...
        <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
            <div class="p-6 text-gray-900 dark:text-gray-100">
                    <form action="{{ route('admin.cms.update', $cmsPage) }}" method="POST" class="space-y-6" 
                        ...
                        <div>
                            ...
                            <input type="text" name="slug" id="slug" value="{{ old('slug', $cmsPage->slug) }}" 
                            ...
                            <div id="slug-warning" class="hidden mt-2 p-3 bg-red-50 dark:bg-red-900/20 border border-red-200 dark:border-red-800 rounded-md">
                        ...
                        <div>
                            ...
                            <input type="text" name="title" id="title" value="{{ old('title', $cmsPage->title) }}" 
                                   class="w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-md shadow-sm focus:outline-none focus:ring-blue-500 focus:border-blue-500 bg-white dark:bg-gray-700 text-gray-900 dark:text-white"
                        ...
                        <div>
                            ...
                            <div class="relative">
                                <textarea name="head_content" id="head_content" rows="4" 
                                          ...
                                          placeholder="<meta name=&quot;description&quot; content=&quot;Your description&quot;>">{{ old('head_content', $cmsPage->head_content) }}</textarea>
                            </div>
                        ...
                        <div>
                            <div class="flex items-center justify-between mb-2">
                                ...
                                <div class="flex gap-2">
                                    ...
                                    <button type="button" 
                                            @click="$dispatch('open-ai-modal', { target: 'body_content', contentType: 'content_improvement' })"
                                            class="btn-secondary text-sm">
                                        <i class="fas fa-robot mr-2"></i>Improve with AI
                                    </button>
                                    <button type="button" 
                                            @click="$dispatch('open-ai-modal', { target: 'body_content', contentType: 'landing_page' })"
                                            class="btn-secondary text-sm">
                            ...
                            <div class="relative">
                                <textarea name="body_content" id="body_content" rows="20" 
                                          class="code-editor w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-md shadow-sm focus:outline-none focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-900 dark:text-white font-mono text-sm"
                                          placeholder="<div class=&quot;container&quot;>Your HTML content here</div>">{{ old('body_content', $cmsPage->body_content) }}</textarea>
                            </div>
                        ...
                        <div>
                            ...
                            <div class="relative">
                                <textarea name="footer_scripts" id="footer_scripts" rows="12" 
                                          class="code-editor w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-md shadow-sm focus:outline-none focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-900 dark:text-white font-mono text-sm"
                                          placeholder="<script>&#10;  // Your JavaScript here&#10;</script>">{{ old('footer_scripts', $cmsPage->footer_scripts) }}</textarea>
                            </div>
                        ...
                        <div x-data="formBuilder()" class="border border-gray-300 dark:border-gray-600 rounded-lg p-6 bg-gray-50 dark:bg-gray-900">
                            <div class="flex items-center justify-between mb-4">
                                <div>
                                    ...
                                    @if ($cmsPage->leads()->count() > 0)
                                        <p class="text-sm text-green-600 dark:text-green-400 mt-1">
                                            <i class="fas fa-check-circle"></i> {{ $cmsPage->leads()->count() }} submission(s) received
                                        </p>
                                    @endif
                                </div>
                                <div class="flex items-center">
                                    ...
                                    <input type="checkbox" name="has_form" id="has_form" value="1" 
                                           x-model="hasForm" {{ old('has_form', $cmsPage->has_form) ? 'checked' : '' }}
                            ...
                            <div x-show="hasForm" x-transition class="space-y-6">
                                        ...
                                        <template x-for="(field, index) in fields" :key="index">
                                            <div class="bg-white dark:bg-gray-800 border border-gray-300 dark:border-gray-600 rounded-lg p-4">
                                                <div class="grid grid-cols-12 gap-3">
                                                    ...
                                                    <div class="col-span-6" x-show="['select', 'radio'].includes(field.type)">
                                ...
                                <div>
                                    ...
                                    <input type="text" name="form_submit_button_text" id="form_submit_button_text" 
                                           value="{{ old('form_submit_button_text', $cmsPage->form_submit_button_text ?? 'Submit') }}" 
                                           class="w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-md shadow-sm focus:outline-none focus:ring-blue-500 focus:border-blue-500 bg-white dark:bg-gray-700 text-gray-900 dark:text-white"
                                           placeholder="Submit">
                                </div>
                                ...
                                <div>
                                    ...
                                    <textarea name="form_success_message" id="form_success_message" rows="3" 
                                              class="w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-md shadow-sm focus:outline-none focus:ring-blue-500 focus:border-blue-500 bg-white dark:bg-gray-700 text-gray-900 dark:text-white"
                                              placeholder="Thank you for your submission!">{{ old('form_success_message', $cmsPage->form_success_message ?? 'Thank you for your submission! We will get back to you soon.') }}</textarea>
                                </div>
                                ...
                                <div>
                                    ...
                                    <input type="text" name="form_redirect_url" id="form_redirect_url" 
                                           value="{{ old('form_redirect_url', $cmsPage->form_redirect_url) }}" 
                                           class="w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-md shadow-sm focus:outline-none focus:ring-blue-500 focus:border-blue-500 bg-white dark:bg-gray-700 text-gray-900 dark:text-white"
                                ...
                                <div class="bg-yellow-50 dark:bg-yellow-900/20 border border-yellow-200 dark:border-yellow-800 rounded-lg p-4 space-y-4">
                                    ...
                                    <div>
                                        ...
                                        <input type="email" name="notification_email" id="notification_email" 
                                               value="{{ old('notification_email', $cmsPage->notification_email) }}" 
                                    ...
                                    <div class="flex items-center">
                                        <input type="checkbox" name="send_admin_notification" id="send_admin_notification" value="1" 
                                               {{ old('send_admin_notification', $cmsPage->send_admin_notification) ? 'checked' : '' }}
                                               class="h-4 w-4 text-blue-600 focus:ring-blue-500 border-gray-300 rounded">
                                    ...
                                    <div class="flex items-center">
                                        <input type="checkbox" name="send_client_notification" id="send_client_notification" value="1" 
                                               {{ old('send_client_notification', $cmsPage->send_client_notification) ? 'checked' : '' }}
                                               class="h-4 w-4 text-blue-600 focus:ring-blue-500 border-gray-300 rounded">
                        ...
                        <!-- Published -->
                        <div class="flex items-center">
                            <input type="checkbox" name="is_published" id="is_published" value="1" {{ old('is_published', $cmsPage->is_published) ? 'checked' : '' }}
                                   class="h-4 w-4 text-blue-600 focus:ring-blue-500 border-gray-300 rounded">
                        ...
                        <div class="flex items-center">
                            ...
                            <input type="checkbox" name="show_navbar" id="show_navbar" value="1" {{ old('show_navbar', $cmsPage->show_navbar ?? true) ? 'checked' : '' }}
                                   class="h-4 w-4 text-blue-600 focus:ring-blue-500 border-gray-300 rounded">
                        ...
                        <div class="flex items-center">
                            ...
                            <input type="checkbox" name="show_footer" id="show_footer" value="1" {{ old('show_footer', $cmsPage->show_footer ?? true) ? 'checked' : '' }}
                                   class="h-4 w-4 text-blue-600 focus:ring-blue-500 border-gray-300 rounded">
                        ...
                        <div x-show="submitting" 
                            ...
                            <div class="bg-white dark:bg-gray-800 rounded-lg shadow-xl px-6 py-4 flex items-center space-x-4">
                                ...
                                <div>
                                    <div class="font-medium text-gray-900 dark:text-gray-100">Updating page...</div>
                                    <div class="text-sm text-gray-600 dark:text-gray-400">Please wait while we save your changes</div>
                                </div>
                            </div>
                        </div>
                    </form>
    ...
    <script>
        function formBuilder() {
            return {
                hasForm: {{ old('has_form', $cmsPage->has_form) ? 'true' : 'false' }},
                fields: {!! old('form_fields') ? old('form_fields') : json_encode($cmsPage->form_fields ?? []) !!},
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            const originalSlug = '{{ $cmsPage->slug }}'; // Store original slug to allow keeping it
            
            const reservedSlugs = [
                'admin', 'api', 'login', 'logout', 'register', 'password', 'dashboard',
                'user', 'users', 'profile', 'settings', 'account', 'oauth', 'auth',
                'email', 'verification', 'verify', 'reset', 'forgot', 'confirm',
                'cms', 'pages', 'forms', 'submissions', 'documents', 'calendar',
                'bookings', 'clients'
            ];
            ...
            function validateSlug() {
                ...
                // Allow the original slug (user is editing existing page)
                if (slug === originalSlug.toLowerCase()) {
