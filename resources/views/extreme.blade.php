...
<body class="bg-[#060d1a] text-gray-100 antialiased font-sans">
    ...
    <nav class="sticky top-0 z-50 border-b border-white/5 backdrop-blur-md bg-[#060d1a]/80">
        <div class="max-w-6xl mx-auto px-6 h-16 flex items-center justify-between">
            <div class="flex items-center gap-3">
                <div class="w-7 h-7 rounded-md bg-gradient-to-br from-indigo-500 to-pink-500 flex items-center justify-center">
            ...
            <div class="flex items-center gap-4">
                ...
                <a href="#start" class="px-4 py-2 rounded-lg bg-indigo-600 hover:bg-indigo-500 text-white text-sm font-medium transition-colors">
                    Build My App
                </a>
            </div>
        </div>
    ...
    <footer class="border-t border-white/5 py-10">
        <div class="max-w-6xl mx-auto px-6 flex flex-col sm:flex-row items-center justify-between gap-4">
            <div class="flex items-center gap-3">
                <div class="w-6 h-6 rounded-md bg-gradient-to-br from-indigo-500 to-pink-500 flex items-center justify-center">
