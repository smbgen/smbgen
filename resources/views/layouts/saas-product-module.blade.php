...
<head>
    ...
    <title>@yield('title', 'SaaS Product Module') — Digital Reputation & Data Suppression</title>
...
<body class="bg-[#060d1a] text-gray-100 antialiased font-sans">
    ...
    <nav class="sticky top-0 z-50 border-b border-white/5 backdrop-blur-md bg-[#060d1a]/80">
        <div class="max-w-6xl mx-auto px-6 h-16 flex items-center justify-between">
            <a href="{{ route('saas-product-module') }}" class="flex items-center gap-3">
            ...
            <div class="flex items-center gap-4">
                @auth
                    <a href="{{ route('saasproductmodule.dashboard') }}" class="hidden md:block text-gray-400 hover:text-white text-sm transition-colors">Dashboard</a>
