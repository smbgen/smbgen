...
<body class="bg-[#060d1a] text-gray-100 antialiased font-sans">
    ...
    <nav class="sticky top-0 z-50 border-b border-red-900/30 backdrop-blur-md bg-[#060d1a]/90"
        ...
        <div class="max-w-6xl mx-auto px-6 h-16 flex items-center justify-between">
            <a href="{{ route('extreme') }}" class="flex items-center gap-3 group">
                {{-- Extreme bolt icon --}}
                ...
                <div class="flex items-baseline gap-2">
                    <span class="text-white font-black text-lg tracking-tight uppercase"
            ...
            <div class="flex items-center gap-4">
                ...
                @endauth
                <a href="{{ route('cleanslate.billing.plans') }}"
