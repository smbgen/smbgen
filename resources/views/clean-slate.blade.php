...
<head>
    ...
    <title>Clean Slate — Digital Reputation & Data Suppression</title>
    ...
    <section class="hero-bg min-h-[90vh] flex items-center">
        <div class="max-w-6xl mx-auto px-6 py-24 text-center">
            ...
            <p class="text-gray-400 text-lg sm:text-xl max-w-2xl mx-auto mb-4 leading-relaxed">
                Clean Slate is a done-for-you data suppression service. A real person finds your exposed personal information across public data broker sites and pursues removal on your behalf — relentlessly.
            </p>
