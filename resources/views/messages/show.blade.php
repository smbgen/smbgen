...
<div class="max-w-4xl mx-auto">
    <div class="flex justify-between items-center mb-6">
        <div>
            <h2 class="text-2xl font-bold text-gray-900 dark:text-gray-100 mb-1">{{ $message->subject ?? 'No Subject' }}</h2>
                        ...
                        <div class="flex-1 min-w-0">
                            <div class="flex items-center justify-between mb-2">
                                <div class="flex items-center gap-2">
                                    <span class="font-semibold text-gray-900 dark:text-gray-100">{{ $msg->sender->name ?? 'Unknown' }}</span>
                            ...
                            <div class="prose dark:prose-invert max-w-none">
                                <div class="whitespace-pre-wrap text-gray-700 dark:text-gray-200 leading-relaxed">{{ $msg->body }}</div>
                            </div>
                        </div>
                    </div>
                </div>
    ...
    <div class="card">
        <div class="p-6 border-b border-gray-200 dark:border-gray-700">
            <h3 class="text-lg font-semibold text-gray-900 dark:text-gray-100 mb-0">
        ...
        <div class="p-6">
            <form method="POST" action="{{ route('messages.reply', $message) }}">
                ...
                <div class="mb-6">
                    <label for="body" class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-2">{{ __('Your Reply') }}</label>
