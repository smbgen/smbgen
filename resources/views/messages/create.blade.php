...
<div class="max-w-4xl mx-auto">
    <h2 class="text-2xl font-bold text-gray-100 mb-6">{{ __('New Message') }}</h2>
                ...
                <form method="POST" action="{{ route('messages.store') }}">
                    ...
                    <div class="mb-6">
                        ...
                        <input type="text" id="recipient_search" 
                               class="form-input w-full mb-2 bg-gray-800 border-gray-700 text-gray-200 focus:border-blue-500 focus:ring-blue-500" 
                               placeholder="Search by name or email...">
                        
                        <select id="recipient_id" name="recipient_id" size="8"
                                class="form-select w-full bg-gray-800 border-gray-700 text-gray-200 focus:border-blue-500 focus:ring-blue-500" required>
                    ...
                    <div class="mb-6">
                        <label for="body" class="block text-sm font-medium text-gray-300 mb-2">{{ __('Message') }}</label>
