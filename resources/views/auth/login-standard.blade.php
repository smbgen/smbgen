    ...
    <div class="bg-white/90 dark:bg-gray-800/90 border border-gray-200 dark:border-gray-700 rounded-[28px] shadow-xl p-6 sm:p-8">
      <div class="space-y-6">
        ...
        <div class="mt-4">
          ...
          <p class="mt-3 text-center text-xs leading-5 text-gray-500 dark:text-gray-400">Using Gmail or Google Workspace? Skip password friction and get in with one click.</p>
        </div>
      </div>
    </div>
  </div>
...
<script>
  (function () {
    ...
    function drawFrame() {
      ...
      const textX = (canvas.width / DPR) * 0.5;
