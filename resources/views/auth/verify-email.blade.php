...
<div class="px-4 w-full max-w-md">
    ...
    <div class="relative bg-gray-800 border border-gray-700 rounded-xl shadow-2xl p-8">
        <!-- Header Icon -->
        ...
        <div class="space-y-4">
            ...
            <form method="POST" action="{{ route('logout') }}">
                @csrf
                <button type="submit" class="w-full px-4 py-3 bg-gray-700 hover:bg-gray-600 text-gray-300 font-medium rounded-lg transition duration-150 ease-in-out">
                    Log Out
                </button>
            </form>
        </div>
