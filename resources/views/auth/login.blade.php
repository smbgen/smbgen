...
<div class="relative w-full flex justify-center items-center px-3 min-h-screen">
  ...
  <div class="px-4 w-full max-w-md z-10">
    <div class="bg-gray-800/90 border border-gray-700 rounded-xl shadow-xl p-6">
      <div class="space-y-6">
      <h2 class="text-center text-2xl font-bold text-gray-100">{{ config('app.company_name', config('app.name')) }}</h2>
  ...
  <footer class="absolute bottom-0 w-full text-center pb-3 text-gray-400 text-sm z-10">
    <div class="opacity-75">
      ...
      <a href="{{ config('app.url') }}/privacy-policy" class="text-gray-300 hover:text-white underline">Privacy</a> ·
      <a href="{{ config('app.url') }}/terms" class="text-gray-300 hover:text-white underline">Terms</a>
    </div>
  </footer>
