...
<div class="px-4 w-full max-w-md relative">
    ...
    <div class="bg-white/90 dark:bg-gray-800/90 border border-gray-200 dark:border-gray-700 rounded-xl shadow-xl p-6 relative z-10">
        <h2 class="text-center text-2xl font-bold text-gray-900 dark:text-white mb-6">Set Your Password</h2>
        <p class="text-center text-gray-700 dark:text-gray-300 text-sm mb-6">Choose how you'd like to access your account</p>
        ...
        <form method="POST" action="{{ route('password.store') }}" class="space-y-4">
            ...
            <div>
                ...
                <div x-data="{ show: false }" class="relative">
                    <input id="password" class="block mt-1 w-full pr-12 bg-gray-50 dark:bg-gray-700 border border-gray-300 dark:border-gray-600 rounded-lg text-gray-900 dark:text-white placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent" x-bind:type="show ? 'text' : 'password'" name="password" required autocomplete="new-password" />
            ...
            <div>
                ...
                <div x-data="{ show: false }" class="relative">
                    <input id="password_confirmation" class="block mt-1 w-full pr-12 bg-gray-50 dark:bg-gray-700 border border-gray-300 dark:border-gray-600 rounded-lg text-gray-900 dark:text-white placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent" x-bind:type="show ? 'text' : 'password'" name="password_confirmation" required autocomplete="new-password" />
                    <button type="button" @click="show = !show" class="absolute inset-y-0 right-0 px-3 flex items-center text-gray-500 dark:text-gray-300 hover:text-gray-700 dark:hover:text-white z-10" aria-label="Toggle password visibility">
                        <svg x-show="!show" xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
                            <path d="M1 12s4-7 11-7 11 7 11 7-4 7-11 7S1 12 1 12Z"/>
                            <circle cx="12" cy="12" r="3"/>
        ...
        <!-- Google OAuth Option -->
        <a href="{{ route('auth.google.redirect') }}" class="w-full inline-flex items-center justify-center px-4 py-3 border border-gray-300 dark:border-gray-600 rounded-lg text-gray-700 dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 transition-colors">
