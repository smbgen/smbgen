...
<div class="container py-8">
    <div class="bg-blue-900 rounded-lg p-8 text-white mb-6">
        <h1 class="text-4xl font-bold mb-2">🛠️ Debug Mode Active</h1>
        <p class="text-blue-200">Application is running in debug mode. These routes are only available when APP_DEBUG=true</p>
    </div>
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
        ...
        <div class="bg-gray-800 rounded-lg p-6">
            ...
            <p class="text-gray-400 mb-4">View error pages directly without triggering actual errors</p>
            <div class="space-y-2">
        ...
        <div class="bg-gray-800 rounded-lg p-6">
            ...
            <p class="text-gray-400 mb-4">Test actual error handling (will trigger real errors)</p>
            <div class="space-y-2">
        ...
        <div class="bg-gray-800 rounded-lg p-6">
            ...
            <div class="space-y-2 text-sm">
                <div class="flex justify-between">
                    ...
                    <span class="text-gray-200 font-mono">{{ app()->environment() }}</span>
                </div>
                <div class="flex justify-between">
                    <span class="text-gray-400">Debug Mode:</span>
                    <span class="text-green-400 font-mono">{{ config('app.debug') ? 'true' : 'false' }}</span>
                </div>
                <div class="flex justify-between">
                    <span class="text-gray-400">Laravel Version:</span>
                    <span class="text-gray-200 font-mono">{{ app()->version() }}</span>
                </div>
                <div class="flex justify-between">
                    <span class="text-gray-400">PHP Version:</span>
                    <span class="text-gray-200 font-mono">{{ PHP_VERSION }}</span>
                </div>
            </div>
        </div>
    ...
    <div class="mt-8 bg-yellow-900/20 border border-yellow-500 text-yellow-300 px-6 py-4 rounded-lg">
