<section class="bg-gray-800 rounded-lg shadow-lg p-6">
    <header class="mb-6">
        <div class="flex items-center mb-3">
            ...
            <div>
                <h2 class="text-xl text-white mb-1 font-semibold">
    ...
    <form method="post" action="{{ route('profile.update') }}" class="space-y-6">
            ...
            <div>
                ...
                <div class="relative">
                    <input 
                        ...
                        name="name" 
                        type="text" 
                        class="w-full px-4 py-3 bg-gray-700 border-2 border-gray-600 text-white rounded-lg focus:border-blue-500 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-opacity-50" 
        ...
        <div class="mt-6 p-6 bg-gray-700 rounded-lg">
            <div class="flex items-center mb-4">
                ...
                <h3 class="text-lg text-white mb-0 font-semibold">Account Information</h3>
            </div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <div class="flex justify-between items-center p-4 bg-gray-800 rounded-lg">
                    <div class="flex items-center">
                        ...
                        <span class="text-gray-300 font-medium">Google ID:</span>
                    </div>
                    <span class="font-mono text-sm bg-gray-600 text-white px-3 py-2 rounded">{{ $user->google_id }}</span>
                </div>
                @endif
                ...
                <div class="flex justify-between items-center p-4 bg-gray-800 rounded-lg">
                    ...
                    <span class="font-medium text-white">{{ $user->created_at ? $user->created_at->format('M j, Y') : 'N/A' }}</span>
                </div>
                ...
                <div class="flex justify-between items-center p-4 bg-gray-800 rounded-lg">
                    <div class="flex items-center">
                        <span class="text-green-400 mr-2">✓</span>
                        <span class="text-gray-300 font-medium">Email Verified:</span>
                    </div>
                    <div class="flex items-center">
