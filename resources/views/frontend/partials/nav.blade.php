...
>
    <div class="max-w-6xl mx-auto px-6 py-4 flex items-center justify-between">
        ...
        <div class="hidden md:flex items-center gap-8 text-sm font-medium text-gray-500">
            <a href="{{ route('home') }}#platform"  class="hover:text-gray-900 transition-colors">Platform</a>
            <a href="{{ route('solutions') }}"       class="hover:text-gray-900 transition-colors">Solutions</a>
            <a href="{{ route('home') }}#growth"    class="hover:text-gray-900 transition-colors">Growth</a>
            <a href="{{ route('home') }}#ai"        class="hover:text-gray-900 transition-colors">AI</a>
    ...
    <div x-show="open" x-transition class="md:hidden border-t border-gray-100 bg-white">
        <div class="max-w-6xl mx-auto px-6 py-4 flex flex-col gap-3">
            <a href="{{ route('home') }}#platform" @click="open=false" class="text-sm font-medium text-gray-600 hover:text-gray-900 py-1">Platform</a>
            <a href="{{ route('solutions') }}"      @click="open=false" class="text-sm font-medium text-gray-600 hover:text-gray-900 py-1">Solutions</a>
            <a href="{{ route('home') }}#growth"    @click="open=false" class="text-sm font-medium text-gray-600 hover:text-gray-900 py-1">Growth</a>
            <a href="{{ route('home') }}#ai"        @click="open=false" class="text-sm font-medium text-gray-600 hover:text-gray-900 py-1">AI</a>
            @if(Route::has('blog.index'))
                <a href="{{ route('blog.index') }}" class="text-sm font-medium text-gray-600 hover:text-gray-900 py-1">Blog</a>
            @endif
            <a href="/contact" @click="open=false" class="text-sm font-medium text-gray-600 hover:text-gray-900 py-1">Contact</a>
