...
@section('title', 'Portal7 — L7 Labs × smbgen Partner Spotlight')
@section('description', 'See how L7 Labs uses Portal7, their smbgen instance, to amplify brand DNA across their entire portfolio — social automation, email marketing, lead capture, and client delivery in one intelligent platform.')

@push('head')
<style>
    .l7-bg {
        background:
            radial-gradient(ellipse at 15% 10%,  rgba(34,197,94,0.08) 0%, transparent 50%),
...
<section class="l7-bg min-h-[92vh] flex items-center px-6 py-20 relative overflow-hidden">
    ...
    {{-- Ambient particles --}}
    <div class="absolute top-20 right-20 w-2 h-2 rounded-full bg-green-400/40 drift"></div>
    <div class="absolute top-1/3 right-1/4 w-1.5 h-1.5 rounded-full bg-green-400/25 drift-slow"></div>
    <div class="absolute bottom-1/3 left-1/5 w-2 h-2 rounded-full bg-blue-400/30 drift"></div>
    <div class="absolute bottom-20 right-1/3 w-1 h-1 rounded-full bg-green-300/40 drift-slow"></div>
        ...
        <div class="grid lg:grid-cols-2 gap-16 items-center">
            ...
            <div>
                ...
                <div class="inline-flex items-center gap-2.5 portal7-badge px-4 py-2 rounded-full mb-10">
                    <span class="text-green-400 text-[10px] font-black uppercase tracking-[0.25em]">Partner Spotlight</span>
                    <span class="w-px h-3 bg-green-400/30"></span>
                ...
                <h1 class="text-5xl md:text-6xl font-black text-white leading-[1.05] tracking-tight mb-7">
                    Where brand DNA<br>
                    meets<br>
                    <span style="background: linear-gradient(135deg, #4ade80, #22c55e, #60a5fa); -webkit-background-clip: text; -webkit-text-fill-color: transparent; background-clip: text;">
                        intelligent delivery.
                    </span>
                </h1>

                <p class="text-gray-400 text-lg leading-relaxed mb-8 max-w-lg font-light">
                    L7 Labs engineers bold brand identities for forward-thinking businesses.
            ...
            <div class="hidden lg:block">
                <div class="relative">
                        ...
                        <div class="flex items-center justify-between mb-7">
                            <div class="flex items-center gap-3">
                                <div class="w-9 h-9 rounded-xl flex items-center justify-center"
                                    ...
                                    <span class="text-green-400 font-black text-sm">P7</span>
                                </div>
                                <div>
                                    <div class="text-white font-black text-sm">Portal7</div>
                                    <div class="text-green-600 text-[10px] font-medium">powered by smbgen</div>
                                </div>
                            </div>
                    ...
                    <div class="absolute -bottom-4 -left-4 drift px-3 py-1.5 rounded-full text-[10px] font-black uppercase tracking-widest text-green-400"
...
{{-- ── HOW IT WORKS ──────────────────────────────────────────────────── --}}
<section class="bg-black py-24 px-6" style="border-top: 1px solid rgba(34,197,94,0.1);">
    <div class="max-w-6xl mx-auto">

        <div class="text-center mb-16">
            <span class="text-green-600 text-xs font-black uppercase tracking-[0.25em] mb-4 block">The Model</span>
            ...
            <p class="text-gray-500 text-lg max-w-2xl mx-auto font-light leading-relaxed">
                L7 Labs engineers the brand strategy, identity, and creative direction.
        ...
        <div class="grid md:grid-cols-3 gap-6">
            ...
            {{-- Step 1 --}}
            <div class="relative">
                <div class="l7-card rounded-2xl p-8 h-full hover:border-green-400/25 transition-all">
                    <div class="w-10 h-10 rounded-xl flex items-center justify-center mb-6 text-green-400 font-black text-lg"
                         style="background: rgba(34,197,94,0.1); border: 1px solid rgba(34,197,94,0.2);">01</div>
                    ...
                    <div class="mt-6 pt-5 flex flex-wrap gap-2" style="border-top: 1px solid rgba(34,197,94,0.1);">
                        @foreach(['Brand Identity', 'Visual System', 'Campaign Strategy', 'Storytelling'] as $tag)
                            <span class="text-[10px] font-bold text-green-600 uppercase tracking-widest px-2.5 py-1 rounded-lg"
                                  style="background: rgba(34,197,94,0.06);">{{ $tag }}</span>
                        @endforeach
                    </div>
                </div>
                <div class="hidden md:flex absolute -right-3 top-1/2 -translate-y-1/2 w-6 h-6 rounded-full items-center justify-center z-10 text-green-400 text-xs"
                     style="background: rgba(34,197,94,0.15); border: 1px solid rgba(34,197,94,0.3);">&rarr;</div>
            </div>
...
<section class="py-24 px-6" style="background: #06060f; border-top: 1px solid rgba(255,255,255,0.04);">
    <div class="max-w-6xl mx-auto">
        ...
        <div class="text-center mb-16">
            <span class="text-green-600 text-xs font-black uppercase tracking-[0.25em] mb-4 block">L7 Portfolio</span>
            <h2 class="text-4xl md:text-5xl font-black text-white tracking-tight mb-5">
            ...
            <div class="rounded-2xl overflow-hidden transition-all hover:-translate-y-1 duration-200"
                ...
                <div class="p-7">
                    <div class="flex items-center gap-3 mb-5">
                        <div class="w-10 h-10 rounded-xl flex items-center justify-center text-green-400 font-black text-sm"
                             style="background: rgba(34,197,94,0.1); border: 1px solid rgba(34,197,94,0.2);">SP</div>
                        <div>
                            ...
                            <a href="https://www.l7medialabs.com/thevault-spatio" target="_blank" rel="noopener"
                               class="text-green-600 text-[10px] hover:text-green-400 transition-colors">l7medialabs.com &rarr;</a>
                        </div>
                    </div>
                    ...
                    <div class="flex flex-wrap gap-1.5">
                        @foreach(['SIGNAL', 'RELAY', 'VAULT'] as $product)
                            <span class="text-[10px] font-black uppercase tracking-widest text-green-400/70 px-2 py-1 rounded"
                                  style="background: rgba(34,197,94,0.07);">{{ $product }}</span>
                        @endforeach
                    </div>
                </div>
            </div>
...
<section class="bg-black py-24 px-6" style="border-top: 1px solid rgba(255,255,255,0.04);">
    <div class="max-w-6xl mx-auto">
        ...
        <div class="grid md:grid-cols-2 gap-16 items-center">
            ...
            <div>
                <span class="text-green-600 text-xs font-black uppercase tracking-[0.25em] mb-5 block">What Portal7 unlocks</span>
                <h2 class="text-4xl md:text-5xl font-black text-white leading-tight tracking-tight mb-6">
                    The operating layer<br>
                    <span class="text-green-400">creative agencies need.</span>
                </h2>
                ...
                <div class="flex flex-col gap-4">
                    @foreach([
                        ['text-green-400', 'bg-green-600/10 border-green-600/25', 'One dashboard for every brand', 'Manage Spatio, The Illustrated Live, MTP, and all future L7 brands from a single Portal7 instance.'],
            ...
            {{-- Metrics panel --}}
            <div class="rounded-2xl p-8" style="background: rgba(255,255,255,0.02); border: 1px solid rgba(34,197,94,0.12);">
                <div class="text-green-700 text-[10px] font-black uppercase tracking-[0.2em] mb-6">Portal7 at a glance</div>
                <div class="grid grid-cols-2 gap-4 mb-6">
                    @foreach([
                        ['3', 'Portfolio Brands', 'text-green-400', 'rgba(34,197,94,0.1)', 'rgba(34,197,94,0.2)'],
                ...
                <div class="rounded-xl p-5" style="background: rgba(34,197,94,0.04); border: 1px solid rgba(34,197,94,0.12);">
                    <div class="text-green-700 text-[10px] font-black uppercase tracking-widest mb-3">Modules running on Portal7</div>
...
<section class="py-24 px-6 relative overflow-hidden" style="background: #04040a; border-top: 1px solid rgba(34,197,94,0.08);">
    <div class="absolute inset-0 opacity-[0.02]" style="background-image: radial-gradient(circle at 1px 1px, #4ade80 1px, transparent 0); background-size: 40px 40px;"></div>
    <div class="max-w-4xl mx-auto text-center relative">
        <div class="text-6xl text-green-800/50 font-black leading-none mb-6">&ldquo;</div>
        ...
        <div class="flex items-center justify-center gap-4">
            <div class="w-10 h-10 rounded-full flex items-center justify-center text-green-400 font-black text-sm"
    ...
    <div class="max-w-5xl mx-auto">
        <div class="grid md:grid-cols-2 gap-6">
            ...
            <div class="rounded-3xl p-10 relative overflow-hidden"
                 style="background: radial-gradient(ellipse at 0% 0%, rgba(34,197,94,0.12) 0%, transparent 60%), rgba(255,255,255,0.02); border: 1px solid rgba(34,197,94,0.2);">
                <div class="w-12 h-12 rounded-2xl flex items-center justify-center mb-6 text-green-400 font-black text-xl"
                     style="background: rgba(34,197,94,0.12); border: 1px solid rgba(34,197,94,0.25);">L7</div>
                <h3 class="text-2xl font-black text-white mb-3 tracking-tight">Work with L7 Labs</h3>
